...
import { DomainLifecycleRegistry } from './domain-lifecycles/domain-lifecycle-registry.js';
...
export function addDomainModel(services) {
  ...
  services.registerSingleton('DomainLifecycleRegistry', () => new DomainLifecycleRegistry());
