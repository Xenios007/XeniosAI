export const GOVERNANCE_COMPLIANCE_ERROR_CODES = Object.freeze({
  ...
  EXCEPTIONS_ISSUES_REMEDIATION_INVALID: 'EXCEPTIONS_ISSUES_REMEDIATION_INVALID',
  FUTURE_GOVERNANCE_EVOLUTION_INVALID: 'FUTURE_GOVERNANCE_EVOLUTION_INVALID'
});
...
export const COMPLIANCE_CONTROL_FRAMEWORK_OBJECTIVES = Object.freeze({
  TRACEABLE_OBLIGATIONS: 'traceable-obligations',
  EXPLICIT_APPLICABILITY: 'explicit-applicability',
  QUALIFIED_INTERPRETATION_OWNERSHIP: 'qualified-interpretation-ownership',
  REUSABLE_CONTROL_OBJECTIVES: 'reusable-control-objectives',
  CONSISTENT_CONTROL_LANGUAGE: 'consistent-control-language',
  PROPORTIONATE_CONTROL_DESIGN: 'proportionate-control-design',
  CLEAR_CONTROL_OWNERSHIP: 'clear-control-ownership',
  EVIDENCE_BY_DESIGN: 'evidence-by-design',
  RELIABLE_CONTROL_TESTING: 'reliable-control-testing',
  TRANSPARENT_EFFECTIVENESS: 'transparent-effectiveness',
  CONTINUOUS_COMPLIANCE_POSTURE: 'continuous-compliance-posture',
  TENANT_AND_JURISDICTION_AWARE_IMPLEMENTATION: 'tenant-and-jurisdiction-aware-implementation',
  SUPPLIER_AND_PROVIDER_ACCOUNTABILITY: 'supplier-and-provider-accountability',
  RESPONSIBLE_AI_CONTROL_COVERAGE: 'responsible-ai-control-coverage',
  EFFICIENT_ASSURANCE_AND_AUDIT: 'efficient-assurance-and-audit',
  TIMELY_RESPONSE_TO_OBLIGATION_CHANGE: 'timely-response-to-obligation-change',
  VENDOR_NEUTRAL_CONTROL_CAPABILITIES: 'vendor-neutral-control-capabilities'
});

export const COMPLIANCE_CONTROL_FRAMEWORK_PRINCIPLES = Object.freeze({
  OBLIGATION_BEFORE_CONTROL: 'obligation-before-control',
  QUALIFIED_INTERPRETATION: 'qualified-interpretation',
  ONE_CONTROL_MANY_OBLIGATIONS: 'one-control-many-obligations',
  CONTROLS_ARE_OUTCOME_BASED: 'controls-are-outcome-based',
  EVIDENCE_BY_DESIGN: 'evidence-by-design',
  EFFECTIVENESS_MUST_BE_DEMONSTRATED: 'effectiveness-must-be-demonstrated',
  APPLICABILITY_IS_EXPLICIT: 'applicability-is-explicit',
  COMPLIANCE_IS_CONTINUOUS: 'compliance-is-continuous'
});

export const COMPLIANCE_MODEL_STAGES = Object.freeze({
  OBLIGATION_SOURCE: 'Obligation Source',
  QUALIFIED_INTERPRETATION: 'Qualified Interpretation',
  APPLICABILITY_AND_REQUIRED_OUTCOME: 'Applicability and Required Outcome',
  POLICY_REQUIREMENT: 'Policy Requirement',
  CONTROL_OBJECTIVE: 'Control Objective',
  IMPLEMENTED_CONTROL: 'Implemented Control',
  OPERATIONAL_EVIDENCE: 'Operational Evidence',
  ASSESSMENT_AND_ASSURANCE: 'Assessment and Assurance',
  COMPLIANCE_POSTURE_FINDING_OR_REMEDIATION: 'Compliance Posture, Finding, or Remediation'
});

export const COMPLIANCE_OBLIGATION_SOURCES = Object.freeze({
  LAWS: 'laws',
  REGULATIONS: 'regulations',
  REGULATORY_GUIDANCE: 'regulatory-guidance',
  LICENSES: 'licenses',
  CONTRACTS: 'contracts',
  TENANT_AGREEMENTS: 'tenant-agreements',
  GUEST_COMMITMENTS: 'guest-commitments',
  SUPPLIER_AGREEMENTS: 'supplier-agreements',
  PAYMENT_REQUIREMENTS: 'payment-requirements',
  PRIVACY_COMMITMENTS: 'privacy-commitments',
  SECURITY_COMMITMENTS: 'security-commitments',
  AI_COMMITMENTS: 'ai-commitments',
  CERTIFICATION_CRITERIA: 'certification-criteria',
  INDUSTRY_STANDARDS: 'industry-standards',
  ...
  ARCHITECTURE_PRINCIPLES: 'architecture-principles',
  SERVICE_COMMITMENTS: 'service-commitments',
  RISK_TREATMENT_DECISIONS: 'risk-treatment-decisions'
});

export const COMPLIANCE_OBLIGATION_TYPES = Object.freeze({
  LEGAL: 'legal-obligation',
  REGULATORY: 'regulatory-obligation',
  CONTRACTUAL: 'contractual-obligation',
  CERTIFICATION: 'certification-obligation',
  POLICY: 'policy-obligation',
  ETHICAL: 'ethical-obligation',
  ARCHITECTURAL: 'architectural-obligation',
  SERVICE: 'service-obligation'
});

export const COMPLIANCE_OBLIGATION_RECORD_FIELDS = Object.freeze({
  OBLIGATION_IDENTIFIER: 'obligation-identifier',
  SOURCE_IDENTIFIER: 'source-identifier',
  SOURCE_TYPE: 'source-type',
  AUTHORITY: 'authority',
  JURISDICTION: 'jurisdiction',
  CITATION_OR_REFERENCE: 'citation-or-reference',
  REQUIREMENT_TEXT_OR_SUMMARY: 'requirement-text-or-authorized-summary',
  ...
  APPLICABILITY: 'applicability',
  EFFECTIVE_DATE: 'effective-date',
  EXPIRATION_OR_SUPERSESSION: 'expiration-or-supersession',
  ...
  REPORTING: 'reporting',
  RETENTION: 'retention',
  EXCEPTIONS_IF_PERMITTED: 'exceptions-if-permitted',
  CHANGE_TRIGGERS: 'change-triggers',
  STATUS: 'status'
});

export const COMPLIANCE_OBLIGATION_LIFECYCLE_STAGES = Object.freeze({
  DISCOVER: 'Discover',
  VALIDATE_SOURCE_AND_AUTHORITY: 'Validate Source and Authority',
  INTERPRET: 'Interpret',
  DETERMINE_APPLICABILITY: 'Determine Applicability',
  MAP_TO_POLICY_AND_CONTROL_OBJECTIVES: 'Map to Policy and Control Objectives',
  IMPLEMENT_CONTROLS: 'Implement Controls',
  COLLECT_EVIDENCE: 'Collect Evidence',
  ASSESS_AND_REPORT: 'Assess and Report',
  MONITOR_CHANGE: 'Monitor Change',
  UPDATE_SUPERSEDE_OR_RETIRE: 'Update, Supersede, or Retire'
});

export const COMPLIANCE_APPLICABILITY_DIMENSIONS = Object.freeze({
  LEGAL_ENTITY: 'legal-entity',
  JURISDICTION: 'jurisdiction',
  TENANT: 'tenant',
  ORGANIZATION: 'organization',
  PROPERTY: 'property',
  GUEST_OR_USER_LOCATION: 'guest-or-user-location',
  DATA_SUBJECT_LOCATION: 'data-subject-location',
  DATA_CATEGORY: 'data-category',
  BUSINESS_CAPABILITY: 'business-capability',
  SERVICE: 'service',
  AI_USE: 'ai-use',
  ...
  ENVIRONMENT: 'environment',
  TIME_PERIOD: 'time-period',
  REVENUE_OR_SIZE_THRESHOLD: 'revenue-or-size-threshold'
});

export const COMPLIANCE_APPLICABILITY_STATES = Object.freeze({
  APPLICABLE: 'applicable',
  NOT_APPLICABLE: 'not-applicable',
  PARTIALLY_APPLICABLE: 'partially-applicable',
  CONDITIONALLY_APPLICABLE: 'conditionally-applicable',
  APPLICABILITY_PENDING: 'applicability-pending',
  INTERPRETATION_REQUIRED: 'interpretation-required',
  SUPERSEDED: 'superseded',
  EXPIRED: 'expired'
});

export const COMPLIANCE_REQUIREMENT_FIELDS = Object.freeze({
  REQUIRED_OUTCOME: 'required-outcome',
  PROHIBITION: 'prohibition',
  SCOPE: 'scope',
  OWNER: 'owner',
...
export const CONTROL_OBJECTIVE_QUALITIES = Object.freeze({
  PURPOSEFUL: 'purposeful',
  TRACEABLE: 'traceable',
  TESTABLE: 'testable',
  TECHNOLOGY_NEUTRAL: 'technology-neutral',
  SCOPE_AWARE: 'scope-aware',
  EVIDENCE_AWARE: 'evidence-aware',
  OWNED: 'owned',
  STABLE_FOR_REUSE: 'stable-enough-for-reuse'
});
...
export const COMPLIANCE_CONTROL_TYPES = Object.freeze({
  PREVENTIVE: 'preventive-control',
  DETECTIVE: 'detective-control',
  CORRECTIVE: 'corrective-control',
  DIRECTIVE: 'directive-control',
  DETERRENT: 'deterrent-control',
  COMPENSATING: 'compensating-control',
  RECOVERY: 'recovery-control'
});

export const CONTROL_EXECUTION_MODELS = Object.freeze({
  MANUAL: 'manual',
  AUTOMATED: 'automated',
  HYBRID: 'hybrid',
  CONTINUOUS: 'continuous',
  ...
  SUPPLIER_OPERATED: 'supplier-operated',
  TENANT_OPERATED: 'tenant-operated',
  PROPERTY_OPERATED: 'property-operated'
});

export const CONTROL_FAMILIES = Object.freeze({
  GOVERNANCE_AND_ACCOUNTABILITY: 'governance-and-accountability',
  ARCHITECTURE_AND_CHANGE: 'architecture-and-change',
  IDENTITY_AND_ACCESS: 'identity-and-access',
  SECURITY: 'security',
  PRIVACY: 'privacy',
  DATA_GOVERNANCE: 'data-governance',
  AI_GOVERNANCE: 'ai-governance',
  SERVICE_OPERATIONS: 'service-operations',
  RESILIENCE_AND_CONTINUITY: 'resilience-and-continuity',
  INTEGRATION_AND_SUPPLIER: 'integration-and-supplier',
  TENANT_AND_PROPERTY: 'tenant-and-property',
  EVIDENCE_AND_ASSURANCE: 'evidence-and-assurance'
});

export const COMPLIANCE_CONTROL_RECORD_FIELDS = Object.freeze({
  ...
  FREQUENCY_OR_TRIGGER: 'frequency-or-trigger',
  SCOPE: 'scope',
  APPLICABILITY: 'applicability',
  RELATED_RISKS: 'related-risks',
  RELATED_OBLIGATIONS: 'related-obligations',
...
export const CONTROL_DESIGN_FIELDS = Object.freeze({
  RISK_OR_OBLIGATION_ADDRESSED: 'risk-or-obligation-addressed',
...
export const CONTROL_DESIGN_EFFECTIVENESS_FACTORS = Object.freeze({
  COVERAGE: 'coverage',
  PRECISION: 'precision',
  TIMELINESS: 'timeliness',
  AUTHORITY: 'authority',
  INDEPENDENCE: 'independence',
  BYPASS_RISK: 'bypass-risk',
...
export const CONTROL_TESTING_FIELDS = Object.freeze({
  OBJECTIVE: 'objective',
  SCOPE: 'scope',
  CRITERIA: 'criteria',
...
export const DESIGN_EFFECTIVENESS_STATES = Object.freeze({
  EFFECTIVE: 'effective',
  PARTIALLY_EFFECTIVE: 'partially-effective',
...
export const OPERATING_EFFECTIVENESS_FACTORS = Object.freeze({
  ...
  TENANT_OR_SCOPE_GAPS: 'tenant-or-scope-gaps',
  REMEDIATION: 'remediation'
});

export const COMPLIANCE_POSTURE_STATES_DETAIL = Object.freeze({
  APPLICABLE_AND_SATISFIED: 'applicable-and-satisfied',
  APPLICABLE_AND_PARTIALLY_SATISFIED: 'applicable-and-partially-satisfied',
  APPLICABLE_AND_NOT_SATISFIED: 'applicable-and-not-satisfied',
  CONTROL_IMPLEMENTED: 'control-implemented',
  CONTROL_OPERATING: 'control-operating',
  CONTROL_EFFECTIVE: 'control-effective',
...
export const CONTINUOUS_COMPLIANCE_CAPABILITIES = Object.freeze({
  APPLICABILITY_MONITORING: 'applicability-monitoring',
  CONFIGURATION_VALIDATION: 'configuration-validation',
  CONTROL_EXECUTION_MONITORING: 'control-execution-monitoring',
  EXCEPTION_EXPIRATION: 'exception-expiration',
  EVIDENCE_COMPLETENESS: 'evidence-completeness',
  OBLIGATION_CHANGE_ALERTS: 'obligation-change-alerts',
  AI_GOVERNANCE_MONITORING: 'ai-governance-monitoring',
  SUPPLIER_CONTROL_MONITORING: 'supplier-control-monitoring',
  TENANT_CONTROL_MONITORING: 'tenant-control-monitoring',
  FINDING_AND_REMEDIATION_STATUS: 'finding-and-remediation-status',
  ASSURANCE_VALIDITY: 'assurance-validity'
});

export const CONTROL_FRAMEWORK_GOVERNANCE_FIELDS = Object.freeze({
  FRAMEWORK_OWNER: 'framework-owner',
  CONTROL_FAMILY_OWNERS: 'control-family-owners',
  NAMING_STANDARDS: 'naming-standards',
  VERSIONING: 'versioning',
  REUSE_RULES: 'reuse-rules',
  INHERITANCE_RULES: 'inheritance-rules',
...
export const CONTROL_LIFECYCLE_STAGES = Object.freeze({
  IDENTIFY_OBJECTIVE: 'Identify Objective',
  DESIGN_CONTROL: 'Design Control',
  APPROVE_AND_IMPLEMENT: 'Approve and Implement',
  OPERATE: 'Operate',
  COLLECT_EVIDENCE: 'Collect Evidence',
  TEST_AND_ASSURE: 'Test and Assure',
  IMPROVE_REPLACE_OR_RETIRE: 'Improve, Replace, or Retire'
});

export const COMPLIANCE_CONTROL_MEASURES = Object.freeze({
  OBLIGATIONS_WITH_OWNERS: 'obligations-with-owners',
  APPLICABILITY_DECISIONS_CURRENT: 'applicability-decisions-current',
  REQUIREMENTS_MAPPED: 'requirements-mapped',
  CONTROLS_WITH_OWNERS: 'controls-with-owners',
  ...
  FINDINGS: 'findings',
  EXCEPTIONS: 'exceptions',
  REMEDIATION_AGE: 'remediation-age',
  SUPPLIER_CONTROL_COVERAGE: 'supplier-control-coverage',
  TENANT_CONTROL_COVERAGE: 'tenant-control-coverage',
  AI_CONTROL_COVERAGE: 'ai-control-coverage',
  ASSESSMENT_TIMELINESS: 'assessment-timeliness',
  OBLIGATION_CHANGE_RESPONSE: 'obligation-change-response'
});

export const COMPLIANCE_CONTROL_QUALITY_ATTRIBUTES = Object.freeze({
  TRACEABILITY: 'traceability',
  CONSISTENCY: 'consistency',
  ACCOUNTABILITY: 'accountability',
  AUDITABILITY: 'auditability',
...
export const COMPLIANCE_CONTROL_ARCHITECTURAL_RULES = Object.freeze({
  IDENTIFY_AUTHORITATIVE_OBLIGATION_SOURCES: 'identify-authoritative-obligation-sources',
  ASSIGN_QUALIFIED_INTERPRETATION_OWNERSHIP: 'assign-qualified-interpretation-ownership',
  DETERMINE_APPLICABILITY_EXPLICITLY: 'determine-applicability-explicitly',
  TRACE_OBLIGATIONS_TO_REQUIREMENTS_CONTROLS_EVIDENCE_AND_ASSURANCE: 'trace-obligations-to-requirements-policies-controls-evidence-and-assurance',
  DEFINE_TECHNOLOGY_NEUTRAL_CONTROL_OBJECTIVES: 'define-technology-neutral-control-objectives',
  REUSE_COMMON_CONTROLS: 'reuse-common-controls-where-appropriate',
  MAKE_INHERITED_RESPONSIBILITIES_EXPLICIT: 'make-inherited-and-consumer-responsibilities-explicit',
  ASSIGN_CONTROL_OWNERS_AND_OPERATORS: 'assign-control-owners-and-operators',
  EVALUATE_EFFECTIVENESS: 'evaluate-design-and-operating-effectiveness',
  DOCUMENTATION_NOT_SUFFICIENT_PROOF: 'treat-documentation-or-configuration-alone-as-insufficient-proof',
  DESIGN_RELIABLE_EVIDENCE_INTO_CONTROLS: 'design-reliable-evidence-into-controls',
  GOVERN_COMPENSATING_CONTROLS_AND_EXCEPTIONS: 'govern-compensating-controls-and-exceptions',
  REPORT_POSTURE_WITH_CONTEXT: 'report-posture-with-context-and-limitations',
  MONITOR_COMPLIANCE_DRIFT: 'monitor-compliance-drift',
  RESPOND_TO_OBLIGATION_CHANGE: 'respond-systematically-to-obligation-change',
  COVER_PLATFORM_SCOPE: 'cover-services-data-ai-workflows-integrations-security-operations-suppliers-tenants-and-properties',
  PRESERVE_TENANT_AND_EVIDENCE_BOUNDARIES: 'preserve-tenant-and-evidence-boundaries',
  AVOID_UNSUPPORTED_COMPLIANCE_CLAIMS: 'avoid-unsupported-compliance-or-certification-claims',
  REMAIN_VENDOR_AND_TECHNOLOGY_NEUTRAL: 'remain-vendor-neutral-and-technology-independent'
});

export const FUTURE_COMPLIANCE_CONTROL_CAPABILITIES = Object.freeze({
  MACHINE_READABLE_OBLIGATIONS: 'machine-readable-obligations',
  SEMANTIC_CONTROL_FRAMEWORKS: 'semantic-control-frameworks',
  AUTOMATED_OBLIGATION_TO_CONTROL_MAPPING: 'automated-obligation-to-control-mapping',
  DYNAMIC_APPLICABILITY: 'dynamic-applicability',
  CONTINUOUS_CONTROL_VERIFICATION: 'continuous-control-verification',
  AI_ASSISTED_CONTROL_DESIGN: 'ai-assisted-control-design',
  PREDICTIVE_COMPLIANCE_DRIFT: 'predictive-compliance-drift',
  AUTOMATED_EVIDENCE_CORRELATION: 'automated-evidence-correlation',
  REAL_TIME_COMPLIANCE_POSTURE: 'real-time-compliance-posture',
  FEDERATED_TENANT_CONTROLS: 'federated-tenant-controls',
  CONTINUOUS_SUPPLIER_ASSURANCE: 'continuous-supplier-assurance',
  POLICY_AWARE_OPERATIONAL_AGENTS: 'policy-aware-operational-agents',
  COMPLIANCE_DIGITAL_TWINS: 'compliance-digital-twins',
  GOVERNED_AUTONOMOUS_REMEDIATION: 'governed-autonomous-remediation'
});

export const PRIVACY_DATA_GOVERNANCE_OBJECTIVES = Object.freeze({
  CLEAR_DATA_ACCOUNTABILITY: 'clear-data-accountability',
  AUTHORIZED_AND_TRANSPARENT_DATA_USE: 'authorized-and-transparent-data-use',
  PURPOSE_LIMITATION: 'purpose-limitation',
  DATA_MINIMIZATION: 'data-minimization',
  CONSISTENT_CLASSIFICATION: 'consistent-classification',
  RELIABLE_DATA_QUALITY: 'reliable-data-quality',
  END_TO_END_LINEAGE: 'end-to-end-lineage',
  LEAST_PRIVILEGE_ACCESS: 'least-privilege-access',
  STRONG_TENANT_ISOLATION: 'strong-tenant-isolation',
  GOVERNED_DATA_SHARING: 'governed-data-sharing',
  JURISDICTION_AWARE_RESIDENCY_AND_TRANSFER: 'jurisdiction-aware-residency-and-transfer',
  ENFORCEABLE_RETENTION_AND_DELETION: 'enforceable-retention-and-deletion',
  EFFECTIVE_RIGHTS_HANDLING: 'effective-rights-handling',
  RESPONSIBLE_AI_DATA_USE: 'responsible-ai-data-use',
  SUPPLIER_ACCOUNTABILITY: 'supplier-accountability',
  PRIVACY_RISK_MANAGEMENT: 'privacy-risk-management',
  TRUSTWORTHY_EVIDENCE: 'trustworthy-evidence',
  VENDOR_NEUTRAL_GOVERNANCE_CAPABILITIES: 'vendor-neutral-governance-capabilities'
});

export const PRIVACY_DATA_GOVERNANCE_PRINCIPLES = Object.freeze({
  DATA_HAS_ACCOUNTABLE_OWNER: 'data-has-accountable-owner',
  PURPOSE_BEFORE_PROCESSING: 'purpose-before-processing',
  MINIMIZE_DATA: 'minimize-data',
  PROTECT_INDIVIDUALS: 'protect-individuals',
  PRESERVE_TENANT_ISOLATION: 'preserve-tenant-isolation',
  QUALITY_MATCHES_PURPOSE: 'quality-matches-purpose',
  LINEAGE_CREATES_ACCOUNTABILITY: 'lineage-creates-accountability',
  RETENTION_IS_INTENTIONAL: 'retention-is-intentional',
  AI_DOES_NOT_CREATE_NEW_RIGHTS: 'ai-does-not-create-new-rights',
  PRIVACY_AND_SECURITY_WORK_TOGETHER: 'privacy-and-security-work-together'
});

export const PRIVACY_DATA_GOVERNANCE_MODEL_STAGES = Object.freeze({
  BUSINESS_PURPOSE_AND_OBLIGATION: 'Business Purpose and Obligation',
  DATA_OWNERSHIP_AND_CLASSIFICATION: 'Data Ownership and Classification',
  AUTHORIZED_COLLECTION_AND_USE: 'Authorized Collection and Use',
  ACCESS_PROCESSING_SHARING_AND_AI_USE: 'Access, Processing, Sharing, and AI Use',
  QUALITY_LINEAGE_SECURITY_AND_TENANT_ISOLATION: 'Quality, Lineage, Security, and Tenant Isolation',
  RETENTION_RIGHTS_DELETION_AND_EXIT: 'Retention, Rights, Deletion, and Exit',
  EVIDENCE_ASSURANCE_RISK_AND_IMPROVEMENT: 'Evidence, Assurance, Risk, and Improvement'
});

export const DATA_GOVERNANCE_DOMAINS = Object.freeze({
  BUSINESS_DATA: 'business-data-governance',
  OPERATIONAL_DATA: 'operational-data-governance',
  SECURITY_DATA: 'security-data-governance',
  AI_DATA: 'ai-data-governance',
  ANALYTICAL_DATA: 'analytical-data-governance',
  GOVERNANCE_EVIDENCE: 'governance-evidence',
  TENANT_AND_PROPERTY_DATA: 'tenant-and-property-data-governance'
});

export const DATA_ROLES = Object.freeze({
  DATA_OWNER: 'data-owner',
  DATA_STEWARD: 'data-steward',
  DATA_CUSTODIAN: 'data-custodian',
  DATA_CONSUMER: 'data-consumer',
  PRIVACY_AUTHORITY: 'privacy-authority',
  TENANT_DATA_AUTHORITY: 'tenant-data-authority',
  PROPERTY_DATA_STEWARD: 'property-data-steward'
});

export const DATA_INVENTORY_FIELDS = Object.freeze({
  DATA_IDENTIFIER: 'data-identifier',
  DATA_DOMAIN: 'data-domain',
  DESCRIPTION: 'description',
  OWNER: 'owner',
  STEWARD: 'steward',
  TENANT_OR_ENTERPRISE_OWNERSHIP: 'tenant-or-enterprise-ownership',
  SOURCE: 'source',
  PURPOSE: 'purpose',
  CLASSIFICATION: 'classification',
  PERSONAL_DATA_STATUS: 'personal-data-status',
  SENSITIVE_DATA_STATUS: 'sensitive-data-status',
  DATA_SUBJECT_OR_ENTITY_CATEGORY: 'data-subject-or-entity-category',
  SERVICES: 'services',
  AI_USES: 'ai-uses',
  WORKFLOWS: 'workflows',
  INTEGRATIONS: 'integrations',
...
export const DATA_CLASSIFICATION_CLASSES = Object.freeze({
  PUBLIC: 'public',
  INTERNAL: 'internal',
...
export const DATA_CLASSIFICATION_LABELS = Object.freeze({
  PERSONAL_DATA: 'personal-data',
  SENSITIVE_PERSONAL_DATA: 'sensitive-personal-data',
  PAYMENT_RELATED_DATA: 'payment-related-data',
  AUTHENTICATION_DATA: 'authentication-data',
  SECURITY_DATA: 'security-data',
  TENANT_CONFIDENTIAL: 'tenant-confidential',
  PROPERTY_CONFIDENTIAL: 'property-confidential',
  AI_CONTEXT: 'ai-context',
  LEGAL_OR_AUDIT_HOLD: 'legal-or-audit-hold',
  OPERATIONAL_EVIDENCE: 'operational-evidence',
  PUBLICLY_SOURCED: 'publicly-sourced',
  DERIVED_OR_INFERRED: 'derived-or-inferred'
});

export const PERSONAL_DATA_CATEGORIES = Object.freeze({
  IDENTITY: 'identity',
  CONTACT: 'contact',
  BOOKING: 'booking',
  STAY: 'stay',
  ...
  DEVICE: 'device',
  LOCATION: 'location',
  PAYMENT_ADJACENT: 'payment-adjacent',
  SUPPORT: 'support',
...
export const SENSITIVE_DATA_CATEGORIES = Object.freeze({
  ...
  HEALTH_OR_ACCESSIBILITY_INFORMATION: 'health-or-accessibility-information',
  PRECISE_LOCATION: 'precise-location',
  SECURITY_INVESTIGATION_DATA: 'security-investigation-data',
  PRIVATE_COMMUNICATIONS: 'private-communications',
  BIOMETRIC_DATA: 'biometric-data',
  CHILDREN_DATA: 'children-data',
  SPECIAL_CATEGORY_PERSONAL_DATA: 'special-category-personal-data',
  HIGHLY_SENSITIVE_TENANT_OR_PROPERTY_DATA: 'highly-sensitive-tenant-or-property-data'
});

export const DATA_PURPOSE_FIELDS = Object.freeze({
  BUSINESS_PURPOSE: 'business-purpose',
  DATA_REQUIRED: 'data-required',
  DATA_SUBJECTS_OR_ENTITIES: 'data-subjects-or-entities',
  OWNER: 'owner',
  AUTHORITY_OR_AUTHORIZED_BASIS: 'authority-or-authorized-basis',
  CONSUMERS: 'consumers',
  AI_USE: 'ai-use',
  SHARING: 'sharing',
  RETENTION: 'retention',
  ...
  RISK: 'risk',
  TRANSPARENCY: 'transparency',
  RIGHTS_HANDLING: 'rights-handling',
  END_CONDITION: 'end-condition'
});

export const AUTHORIZED_BASIS_FIELDS = Object.freeze({
  JURISDICTION: 'jurisdiction',
  APPLICABILITY: 'applicability',
  PURPOSE: 'purpose',
  DATA: 'data',
  ...
  EVIDENCE: 'evidence',
  EXPIRATION: 'expiration',
  WITHDRAWAL_OR_OBJECTION_HANDLING: 'withdrawal-or-objection-handling'
});

export const DATA_LIFECYCLE_STAGES = Object.freeze({
  PLAN_PURPOSE: 'Plan Purpose',
  COLLECT_OR_RECEIVE: 'Collect or Receive',
  VALIDATE_AND_CLASSIFY: 'Validate and Classify',
  STORE_AND_PROTECT: 'Store and Protect',
  USE_ANALYZE_OR_INFER: 'Use, Analyze, or Infer',
  SHARE_OR_TRANSFER: 'Share or Transfer',
  RETAIN_OR_ARCHIVE: 'Retain or Archive',
  DELETE_ANONYMIZE_RETURN_OR_DISPOSE: 'Delete, Anonymize, Return, or Dispose'
});

export const DATA_COLLECTION_QUALITIES = Object.freeze({
  PURPOSEFUL: 'purposeful',
  ...
  EVIDENCE_GENERATING: 'evidence-generating'
});

export const DATA_MINIMIZATION_LEVERS = Object.freeze({
  FIELDS_COLLECTED: 'fields-collected',
  PRECISION: 'precision',
  FREQUENCY: 'frequency',
  HISTORICAL_DEPTH: 'historical-depth',
  NUMBER_OF_RECIPIENTS: 'number-of-recipients',
  RETENTION: 'retention',
  CONTEXT_PROVIDED_TO_AI: 'context-provided-to-ai',
  COPIES: 'copies',
...
export const ANONYMIZATION_PSEUDONYMIZATION_FIELDS = Object.freeze({
  METHOD: 'method',
  OWNER: 'owner',
  RE_IDENTIFICATION_RISK: 're-identification-risk',
  KEY_SEPARATION: 'key-separation',
  AUTHORIZED_RE_LINKING: 'authorized-re-linking',
  PURPOSE: 'purpose',
...
export const TRANSPARENCY_FIELDS = Object.freeze({
  DATA_USED: 'data-used',
  PURPOSE: 'purpose',
  ...
  CHOICES: 'choices',
  RIGHTS: 'rights',
  CONTACT_AND_RECOURSE: 'contact-and-recourse',
  MATERIAL_CHANGES: 'material-changes'
});

export const DATA_ACCESS_REQUIREMENTS = Object.freeze({
  VERIFIED_IDENTITY: 'verified-identity',
  LEAST_PRIVILEGE: 'least-privilege',
  AUTHORIZED_PURPOSE: 'authorized-purpose',
  ROLE_AND_ATTRIBUTE_CONSTRAINTS: 'role-and-attribute-constraints',
  TENANT_AND_PROPERTY_SCOPE: 'tenant-and-property-scope',
  TIME_LIMITATION: 'time-limitation',
  SENSITIVE_DATA_RESTRICTIONS: 'sensitive-data-restrictions',
  SEPARATION_OF_DUTIES: 'separation-of-duties',
  MONITORING: 'monitoring',
  REVIEW: 'review',
...
export const PURPOSE_AWARE_ACCESS_DIMENSIONS = Object.freeze({
  REQUESTED_PURPOSE: 'requested-purpose',
  DATA_CATEGORY: 'data-category',
  TENANT: 'tenant',
  PROPERTY: 'property',
  SERVICE: 'service',
  ...
  ENVIRONMENT: 'environment',
  RISK: 'risk',
  CONSENT_OR_AUTHORIZATION_CONDITION: 'consent-or-authorization-condition'
});
...
export const DATA_QUALITY_RULE_FIELDS = Object.freeze({
...
export const DATA_METADATA_FIELDS = Object.freeze({
  MEANING: 'meaning',
  OWNER: 'owner',
  CLASSIFICATION: 'classification',
  PURPOSE: 'purpose',
...
export const DATA_LINEAGE_FIELDS = Object.freeze({
  ORIGIN: 'origin',
...
export const DERIVED_INFERRED_DATA_FIELDS = Object.freeze({
  ...
  RETENTION: 'retention',
  RIGHTS_IMPACT: 'rights-impact',
  AI_INVOLVEMENT: 'ai-involvement',
  VALIDATION: 'validation',
  RECOURSE: 'recourse'
});

export const DATA_SHARING_FIELDS = Object.freeze({
  PURPOSE: 'purpose',
  SENDER: 'sender',
  RECIPIENT: 'recipient',
  DATA: 'data',
  ...
  SECURITY: 'security',
  RETENTION: 'retention',
  FURTHER_SHARING: 'further-sharing',
  DELETION: 'deletion',
  EVIDENCE: 'evidence',
  INCIDENT_OBLIGATIONS: 'incident-obligations',
  EXIT: 'exit'
});

export const DATA_DISCLOSURE_CLASSES = Object.freeze({
  INTERNAL: 'internal',
  TENANT_AUTHORIZED: 'tenant-authorized',
  PROPERTY_AUTHORIZED: 'property-authorized',
  SUPPLIER: 'supplier',
  PARTNER: 'partner',
  GUEST_OR_INDIVIDUAL: 'guest-or-individual',
  LEGAL_OR_REGULATORY: 'legal-or-regulatory',
  EMERGENCY: 'emergency',
  PUBLIC: 'public'
});

export const DATA_RESIDENCY_FIELDS = Object.freeze({
  DATA_CATEGORY: 'data-category',
  REQUIRED_OR_PREFERRED_LOCATION: 'required-or-preferred-location',
  LEGAL_ENTITY: 'legal-entity',
  TENANT: 'tenant',
  JURISDICTION: 'jurisdiction',
...
export const CROSS_BORDER_MOVEMENT_VECTORS = Object.freeze({
  STORAGE: 'storage',
  REPLICATION: 'replication',
  BACKUP: 'backup',
  SUPPORT: 'support',
...
export const RETENTION_BASIS_FACTORS = Object.freeze({
  PURPOSE: 'purpose',
  OBLIGATION: 'obligation',
  CONTRACT: 'contract',
  RISK: 'risk',
  ...
  RIGHTS: 'rights',
  SECURITY: 'security',
  LITIGATION_OR_LEGAL_HOLD: 'litigation-or-legal-hold',
  TENANT_REQUIREMENT: 'tenant-requirement',
  PROPERTY_REQUIREMENT: 'property-requirement',
  COST: 'cost',
  ARCHIVAL_VALUE: 'archival-value'
});

export const RETENTION_SCHEDULE_FIELDS = Object.freeze({
...
export const DATA_HOLD_FIELDS = Object.freeze({
  AUTHORITY: 'authority',
  SCOPE: 'scope',
  DATA: 'data',
  CUSTODIAN: 'custodian',
  ...
  REVIEW: 'review',
  RELEASE: 'release',
  DELETION_RESUMPTION: 'deletion-resumption',
  EVIDENCE: 'evidence'
});

export const DATA_DELETION_SCOPES = Object.freeze({
  PRIMARY_STORES: 'primary-stores',
  REPLICAS: 'replicas',
  CACHES: 'caches',
...
export const DATA_RETURN_PORTABILITY_FIELDS = Object.freeze({
  IDENTITY_VERIFICATION: 'identity-verification',
  SCOPE: 'scope',
  FORMAT: 'format',
  SECURITY: 'security',
  DATA_LINEAGE: 'data-lineage',
  THIRD_PARTY_DATA_SEPARATION: 'third-party-data-separation',
  TENANT_ISOLATION: 'tenant-isolation',
  TIMING: 'timing',
  EVIDENCE: 'evidence',
  DELETION_AFTER_RETURN: 'deletion-after-return',
  CONTRACTUAL_CONDITIONS: 'contractual-conditions'
});

export const INDIVIDUAL_RIGHTS = Object.freeze({
  ACCESS: 'access',
  CORRECTION: 'correction',
  DELETION: 'deletion',
  ...
  REVIEW_OF_AUTOMATED_DECISION: 'review-of-automated-decision',
  COMPLAINT_OR_RECOURSE: 'complaint-or-recourse'
});

export const RIGHTS_HANDLING_FIELDS = Object.freeze({
  ...
  TENANT_COORDINATION: 'tenant-coordination'
});

export const AUTOMATED_DECISION_FIELDS = Object.freeze({
  PURPOSE: 'purpose',
  DATA: 'data',
  LOGIC_OR_MEANINGFUL_EXPLANATION: 'logic-or-meaningful-explanation',
  AI_INVOLVEMENT: 'ai-involvement',
  IMPACT: 'impact',
  ACCURACY: 'accuracy',
  FAIRNESS: 'fairness',
  ...
  EVIDENCE: 'evidence',
  MONITORING: 'monitoring',
  JURISDICTIONAL_APPLICABILITY: 'jurisdictional-applicability'
});

export const AI_DATA_GOVERNANCE_CATEGORIES = Object.freeze({
...
export const AI_PROVIDER_DATA_USE_FIELDS = Object.freeze({
  PURPOSE: 'purpose',
  DATA_CLASSIFICATION: 'data-classification',
...
export const AGENT_MEMORY_GOVERNANCE_FIELDS = Object.freeze({
  PURPOSE: 'purpose',
  SCOPE: 'scope',
  TENANT: 'tenant',
  PROPERTY: 'property',
  ...
  CONFIDENCE: 'confidence',
  ACCESS: 'access',
  CROSS_SESSION_USE: 'cross-session-use',
  CROSS_AGENT_SHARING: 'cross-agent-sharing',
  EVIDENCE: 'evidence'
});

export const TENANT_DATA_GOVERNANCE_FIELDS = Object.freeze({
  TENANT_OWNERSHIP: 'tenant-ownership',
  ENTERPRISE_PROCESSING_RESPONSIBILITIES: 'enterprise-processing-responsibilities',
  TENANT_ADMINISTRATORS: 'tenant-administrators',
  TENANT_PURPOSES: 'tenant-purposes',
...
export const CROSS_TENANT_DATA_USE_CONDITIONS = Object.freeze({
  AUTHORIZED_PURPOSE: 'authorized-purpose',
  GOVERNED_AGGREGATION_OR_ANONYMIZATION: 'governed-aggregation-or-anonymization',
  CONTRACT_AND_POLICY_ALLOWANCE: 'contract-and-policy-allowance',
  PRIVACY_AND_SECURITY_RISK_ASSESSMENT: 'privacy-and-security-risk-assessment',
  TENANT_BOUNDARY_PROTECTION: 'tenant-boundary-protection',
  RE_IDENTIFICATION_RISK_CONTROL: 're-identification-risk-control',
  EVIDENCE_RETENTION: 'evidence-retention',
  APPROPRIATE_TRANSPARENCY: 'appropriate-transparency'
});

export const PROPERTY_DATA_GOVERNANCE_FIELDS = Object.freeze({
...
export const SUPPLIER_PROCESSOR_GOVERNANCE_FIELDS = Object.freeze({
  DUE_DILIGENCE: 'due-diligence',
  PURPOSE: 'purpose',
  DATA_SCOPE: 'data-scope',
  ROLE: 'role',
...
export const PRIVACY_IMPACT_ASSESSMENT_TRIGGERS = Object.freeze({
  NEW_DATA_PURPOSE: 'new-data-purpose',
  SENSITIVE_DATA: 'sensitive-data',
  LARGE_SCALE_PROCESSING: 'large-scale-processing',
  AI_INFERENCE: 'ai-inference',
  CONSEQUENTIAL_AUTOMATED_DECISION: 'consequential-automated-decision',
  NEW_PROVIDER: 'new-provider',
  CROSS_BORDER_TRANSFER: 'cross-border-transfer',
  CROSS_TENANT_USE: 'cross-tenant-use',
  NEW_MONITORING: 'new-monitoring',
  NEW_INTEGRATION: 'new-integration',
  MATERIAL_DATA_COMBINATION: 'material-data-combination',
  NEW_PROPERTY_OR_JURISDICTION: 'new-property-or-jurisdiction',
  HIGH_RISK_PROCESSING: 'high-risk-processing'
});

export const PRIVACY_IMPACT_ASSESSMENT_FIELDS = Object.freeze({
  PURPOSE: 'purpose',
  NECESSITY: 'necessity',
...
export const DATA_PROTECTION_BY_DESIGN_CONTROLS = Object.freeze({
  MINIMIZATION: 'minimization',
  PURPOSE_CONSTRAINTS: 'purpose-constraints',
  DEFAULT_RESTRICTIONS: 'default-restrictions',
  TENANT_ISOLATION: 'tenant-isolation',
  LEAST_PRIVILEGE: 'least-privilege',
  ...
  EVIDENCE: 'evidence',
  SAFE_AI_CONTEXT: 'safe-ai-context',
...
export const DATA_INCIDENT_TYPES = Object.freeze({
  ...
  INCORRECT_USE: 'incorrect-use',
  PRIVACY_BREACH: 'privacy-breach',
  RIGHTS_FAILURE: 'rights-failure',
  RETENTION_FAILURE: 'retention-failure',
  DELETION_FAILURE: 'deletion-failure',
  CROSS_TENANT_EXPOSURE: 'cross-tenant-exposure',
  AI_LEAKAGE: 'ai-leakage',
  SUPPLIER_INCIDENT: 'supplier-incident'
});

export const DATA_INCIDENT_ASSESSMENT_FIELDS = Object.freeze({
  DATA: 'data',
  CLASSIFICATION: 'classification',
  INDIVIDUALS_OR_ENTITIES: 'individuals-or-entities',
...
export const DATA_GOVERNANCE_EVIDENCE_TYPES = Object.freeze({
  OWNERSHIP: 'ownership',
  CLASSIFICATION: 'classification',
  PURPOSE: 'purpose',
  ACCESS_DECISIONS: 'access-decisions',
...
export const PRIVACY_DATA_ASSURANCE_AREAS = Object.freeze({
...
export const DATA_GOVERNANCE_MEASURES = Object.freeze({
  DATA_DOMAINS_WITH_OWNERS: 'data-domains-with-owners',
  CLASSIFICATION_COMPLETENESS: 'classification-completeness',
  PURPOSE_COVERAGE: 'purpose-coverage',
  ACCESS_REVIEW_COMPLETION: 'access-review-completion',
  QUALITY_RULE_ATTAINMENT: 'quality-rule-attainment',
  LINEAGE_COVERAGE: 'lineage-coverage',
  RETENTION_COMPLIANCE: 'retention-compliance',
  DELETION_COMPLETION: 'deletion-completion',
  RIGHTS_REQUEST_TIMELINESS: 'rights-request-timeliness',
  PRIVACY_ASSESSMENTS: 'privacy-assessments',
  DATA_INCIDENTS: 'data-incidents',
  CROSS_TENANT_EXCEPTIONS: 'cross-tenant-exceptions',
  SUPPLIER_COVERAGE: 'supplier-coverage',
  AI_DATA_USE_REVIEWS: 'ai-data-use-reviews',
  DATA_FINDINGS: 'data-findings',
  REMEDIATION_AGE: 'remediation-age'
});

export const PRIVACY_DATA_GOVERNANCE_QUALITY_ATTRIBUTES = Object.freeze({
  PRIVACY: 'privacy',
  SECURITY: 'security',
  INTEGRITY: 'integrity',
  CONFIDENTIALITY: 'confidentiality',
...
export const PRIVACY_DATA_GOVERNANCE_ARCHITECTURAL_RULES = Object.freeze({
  ASSIGN_ACCOUNTABLE_DATA_OWNERS: 'assign-accountable-data-owners',
  DEFINE_AUTHORIZED_PURPOSE_BEFORE_PROCESSING: 'define-authorized-purpose-before-processing',
  MINIMIZE_COLLECTION_USE_SHARING_AND_RETENTION: 'minimize-data-collection-use-sharing-and-retention',
  CLASSIFY_DATA_CONSISTENTLY: 'classify-data-consistently',
  PROTECT_SENSITIVE_AND_PERSONAL_DATA: 'protect-sensitive-and-personal-data',
  ENFORCE_LEAST_PRIVILEGE_AND_PURPOSE_AWARE_ACCESS: 'enforce-least-privilege-and-purpose-aware-access',
  PRESERVE_TENANT_AND_PROPERTY_BOUNDARIES: 'preserve-tenant-and-property-boundaries',
  MAINTAIN_QUALITY_APPROPRIATE_TO_PURPOSE: 'maintain-quality-appropriate-to-purpose',
  MAINTAIN_MATERIAL_METADATA_AND_LINEAGE: 'maintain-material-metadata-and-lineage',
  GOVERN_DERIVED_AND_INFERRED_DATA: 'govern-derived-and-inferred-data',
  CONTROL_SHARING_SUPPLIERS_RESIDENCY_AND_CROSS_BORDER_MOVEMENT: 'control-sharing-suppliers-residency-and-cross-border-movement',
  DEFINE_RETENTION_HOLD_DELETION_RETURN_AND_EXIT: 'define-retention-hold-deletion-return-and-exit',
  SUPPORT_APPLICABLE_INDIVIDUAL_RIGHTS: 'support-applicable-individual-rights',
  GOVERN_AUTOMATED_DECISIONS_AND_AI_DATA_LIFECYCLES: 'govern-automated-decisions-and-ai-data-throughout-lifecycles',
  ASSESS_HIGH_RISK_PROCESSING_BEFORE_PRODUCTION: 'assess-high-risk-processing-before-production',
  INTEGRATE_PRIVACY_SECURITY_AND_DATA_INCIDENT_RESPONSE: 'integrate-privacy-security-and-data-incident-response',
  DESIGN_TRUSTWORTHY_EVIDENCE_INTO_DATA_OPERATIONS: 'design-trustworthy-evidence-into-data-operations',
  AVOID_LEGAL_INTERPRETATION_WITHOUT_QUALIFIED_AUTHORITY: 'avoid-interpreting-legal-requirements-without-qualified-authority',
  REMAIN_VENDOR_AND_TECHNOLOGY_NEUTRAL: 'remain-vendor-neutral-and-technology-independent'
});

export const FUTURE_PRIVACY_DATA_GOVERNANCE_CAPABILITIES = Object.freeze({
  SEMANTIC_DATA_INVENTORIES: 'semantic-data-inventories',
  AUTOMATED_CLASSIFICATION: 'automated-classification',
  PURPOSE_AWARE_AUTHORIZATION: 'purpose-aware-authorization',
  MACHINE_READABLE_PROCESSING_RECORDS: 'machine-readable-processing-records',
  CONTINUOUS_LINEAGE: 'continuous-lineage',
  PRIVACY_PRESERVING_ANALYTICS: 'privacy-preserving-analytics',
  FEDERATED_LEARNING: 'federated-learning',
  SYNTHETIC_DATA_GOVERNANCE: 'synthetic-data-governance',
  AUTOMATED_RETENTION: 'automated-retention',
  VERIFIABLE_DELETION: 'verifiable-deletion',
  DYNAMIC_RESIDENCY_CONTROL: 'dynamic-residency-control',
  AI_ASSISTED_RIGHTS_HANDLING: 'ai-assisted-rights-handling',
...
export const EXCEPTIONS_ISSUES_REMEDIATION_OBJECTIVES = Object.freeze({
  TRANSPARENT_DEVIATIONS: 'transparent-deviations',
  EXPLICIT_EXCEPTION_AUTHORITY: 'explicit-exception-authority',
  TIME_BOUNDED_EXCEPTIONS: 'time-bounded-exceptions',
  EFFECTIVE_COMPENSATING_CONTROLS: 'effective-compensating-controls',
  CONSISTENT_ISSUE_CLASSIFICATION: 'consistent-issue-classification',
  CLEAR_OWNERSHIP: 'clear-ownership',
  RAPID_CONTAINMENT: 'rapid-containment',
  SYSTEMIC_ROOT_CAUSE_LEARNING: 'systemic-root-cause-learning',
  ACCOUNTABLE_REMEDIATION: 'accountable-remediation',
  RISK_PROPORTIONATE_DEADLINES: 'risk-proportionate-deadlines',
  INDEPENDENT_VERIFICATION: 'independent-verification-where-required',
  CONTROLLED_RESIDUAL_RISK_ACCEPTANCE: 'controlled-residual-risk-acceptance',
  PREVENT_RECURRING_DEFICIENCIES: 'prevention-of-recurring-deficiencies',
  TENANT_AND_PROPERTY_ISOLATION: 'tenant-and-property-isolation',
  SUPPLIER_ACCOUNTABILITY: 'supplier-accountability',
  RELIABLE_EVIDENCE_AND_REPORTING: 'reliable-evidence-and-reporting',
  VENDOR_NEUTRAL_REMEDIATION_CAPABILITIES: 'vendor-neutral-remediation-capabilities'
});

export const EXCEPTIONS_ISSUES_REMEDIATION_PRINCIPLES = Object.freeze({
  EXCEPTIONS_ARE_TEMPORARY: 'exceptions-are-temporary',
  NO_EXCEPTION_WITHOUT_AUTHORITY: 'no-exception-without-authority',
  LEGAL_PROHIBITIONS_CANNOT_BE_WAIVED_INTERNALLY: 'legal-prohibitions-cannot-be-waived-internally',
  EVERY_ISSUE_HAS_OWNER: 'every-issue-has-an-owner',
  CONTAIN_BEFORE_CORRECTING: 'contain-before-correcting',
  FIX_CAUSES_NOT_ONLY_SYMPTOMS: 'fix-causes-not-only-symptoms',
  CLOSURE_REQUIRES_EVIDENCE: 'closure-requires-evidence',
  DELAYS_ARE_RISK_DECISIONS: 'delays-are-risk-decisions',
  RECURRENCE_SIGNALS_SYSTEMIC_WEAKNESS: 'recurrence-signals-systemic-weakness'
});

export const EXCEPTION_ELIGIBILITY_REASONS = Object.freeze({
  CONTROL_CANNOT_BE_IMPLEMENTED_BY_DATE: 'control-cannot-be-implemented-by-required-date',
  LEGACY_OR_SUPPLIER_CONSTRAINT: 'legacy-or-supplier-constraint',
  TEMPORARY_BUSINESS_NEED: 'temporary-business-need',
  MIGRATION_OR_TRANSITION: 'migration-or-transition',
  TENANT_OR_PROPERTY_SPECIAL_CONDITION: 'tenant-or-property-bounded-special-condition',
  EMERGENCY_ACTION: 'emergency-action-temporarily-departs-from-policy',
  ALTERNATIVE_CONTROL: 'alternative-control-achieves-comparable-outcomes',
  QUALIFIED_INTERPRETATION: 'requirement-under-qualified-interpretation',
  ARCHITECTURE_EVOLUTION: 'architecture-evolution-controlled-transition'
});

export const EXCEPTION_SCOPE_DIMENSIONS = Object.freeze({
...
export const EXCEPTION_RECORD_FIELDS = Object.freeze({
  ...
  POLICY_STANDARD_CONTROL_OR_ARCHITECTURE_REFERENCE: 'policy-standard-control-or-architecture-reference',
  BUSINESS_JUSTIFICATION: 'business-justification',
  OWNER: 'owner',
  REQUESTOR: 'requestor',
  AUTHORITY: 'authority',
  ...
  RISK_STATEMENT: 'risk-statement',
  INHERENT_AND_RESIDUAL_RISK: 'inherent-and-residual-risk',
  AFFECTED_OBLIGATIONS: 'affected-obligations',
  COMPENSATING_CONTROLS: 'compensating-controls',
  MONITORING: 'monitoring',
  EVIDENCE: 'evidence',
  COMMUNICATION: 'communication',
  ...
  REVOCATION_CONDITIONS: 'revocation-conditions',
  RELATED_ISSUES_AND_FINDINGS: 'related-issues-and-findings',
  STATUS: 'status',
  CLOSURE_EVIDENCE: 'closure-evidence'
});

export const EXCEPTION_LIFECYCLE_STAGES = Object.freeze({
  IDENTIFY_NEED: 'Identify Need',
  CONFIRM_ELIGIBILITY_AND_AUTHORITY: 'Confirm Eligibility and Authority',
  DEFINE_SCOPE_AND_DURATION: 'Define Scope and Duration',
  ASSESS_OBLIGATIONS_AND_RISK: 'Assess Obligations and Risk',
  DESIGN_COMPENSATING_CONTROLS: 'Design Compensating Controls',
  APPROVE_OR_REJECT: 'Approve or Reject',
  IMPLEMENT_COMMUNICATE_AND_MONITOR: 'Implement, Communicate, and Monitor',
  REVIEW_AND_REASSESS: 'Review and Reassess',
  EXPIRE_REVOKE_EXTEND_OR_CLOSE: 'Expire, Revoke, Extend, or Close'
});
...
export const EXCEPTION_AUTHORITY_FACTORS = Object.freeze({
  REQUIREMENT_SOURCE: 'requirement-source',
  LEGAL_OR_CONTRACTUAL_SIGNIFICANCE: 'legal-or-contractual-significance',
  SECURITY: 'security',
  PRIVACY: 'privacy',
  AI_IMPACT: 'ai-impact',
  DATA_SENSITIVITY: 'data-sensitivity',
  ...
  REVERSIBILITY: 'reversibility',
  RESIDUAL_RISK: 'residual-risk',
  CROSS_ENTERPRISE_EFFECT: 'cross-enterprise-effect'
});

export const COMPENSATING_CONTROL_REQUIREMENTS = Object.freeze({
  ADDRESS_SAME_OBJECTIVE_OR_RISK: 'address-same-objective-or-material-risk',
  IMPLEMENTED_BEFORE_OR_WITH_EXCEPTION: 'implemented-before-or-with-exception-activation',
  ACCOUNTABLE_OWNERSHIP: 'accountable-ownership',
  PRODUCE_EVIDENCE: 'produce-evidence',
  MONITORED: 'monitored',
  FAILURE_HANDLING: 'failure-handling',
  TENANT_AND_PROPERTY_BOUNDARIES: 'tenant-and-property-boundaries',
  REVIEWED_THROUGHOUT_EXCEPTION: 'reviewed-throughout-exception',
  RETIRED_WHEN_NO_LONGER_NEEDED: 'retired-when-no-longer-needed'
});

export const EMERGENCY_EXCEPTION_FIELDS = Object.freeze({
  EMERGENCY_AUTHORITY: 'emergency-authority',
  CONDITION: 'condition',
  SCOPE: 'scope',
  ACTION: 'action',
...
export const EXCEPTION_EXTENSION_FACTORS = Object.freeze({
  CONTINUING_BUSINESS_NEED: 'continuing-business-need',
  UPDATED_OBLIGATIONS: 'updated-obligations',
  ...
  CUMULATIVE_DURATION: 'cumulative-duration',
  COMPENSATING_CONTROLS: 'compensating-controls',
  AUTHORITY: 'authority',
  REVISED_EXPIRATION: 'revised-expiration'
});

export const EXCEPTION_REVOCATION_TRIGGERS = Object.freeze({
  RISK_INCREASES: 'risk-increases',
  COMPENSATING_CONTROLS_FAIL: 'compensating-controls-fail',
  SCOPE_EXPANDS: 'scope-expands',
  CONDITIONS_VIOLATED: 'conditions-violated',
  SECURITY_OR_PRIVACY_CONCERNS: 'security-or-privacy-concerns',
  OBLIGATION_CHANGES: 'obligation-changes',
  BUSINESS_JUSTIFICATION_ENDS: 'business-justification-ends',
  PROHIBITED_CONDITION_DISCOVERED: 'prohibited-condition-discovered',
  REQUIRED_EVIDENCE_UNAVAILABLE: 'required-evidence-unavailable',
  REMEDIATION_AVAILABLE: 'remediation-available'
});

export const EXCEPTION_CLOSURE_CONDITIONS = Object.freeze({
  REQUIREMENT_SATISFIED: 'requirement-satisfied',
  PERMANENT_APPROVED_ALTERNATIVE_IMPLEMENTED: 'permanent-approved-alternative-implemented',
  AFFECTED_ACTIVITY_ENDS: 'affected-activity-ends',
  POLICY_OR_STANDARD_VALIDLY_CHANGED: 'policy-or-standard-validly-changed',
  SCOPE_NO_LONGER_APPLIES: 'scope-no-longer-applies',
  REPLACED_BY_AUTHORIZED_DECISION: 'replaced-by-authorized-decision'
});
...
export const ISSUE_TYPES = Object.freeze({
  ...
  COMPLIANCE_NONCONFORMITY: 'compliance-nonconformity',
  ARCHITECTURE_DEVIATION: 'architecture-deviation',
  SECURITY_WEAKNESS: 'security-weakness',
  PRIVACY_WEAKNESS: 'privacy-weakness',
  DATA_GOVERNANCE_FAILURE: 'data-quality-or-governance-failure',
  AI_GOVERNANCE_FAILURE: 'ai-governance-failure',
  OPERATIONAL_DEFICIENCY: 'operational-deficiency',
  SUPPLIER_FAILURE: 'supplier-failure',
  TENANT_CONTROL_FAILURE: 'tenant-control-failure',
  PROPERTY_PROCEDURE_FAILURE: 'property-procedure-failure',
  MISSING_EVIDENCE: 'missing-evidence',
  UNAUTHORIZED_EXCEPTION: 'unauthorized-exception',
  OVERDUE_REMEDIATION: 'overdue-remediation',
  REPEATED_INCIDENT: 'repeated-incident',
  ASSURANCE_LIMITATION: 'assurance-limitation-requiring-correction'
});
...
export const FINDING_FIELDS = Object.freeze({
  ...
  EVIDENCE: 'evidence',
  SCOPE: 'scope',
  RECOMMENDATION_OR_REQUIRED_OUTCOME: 'recommendation-or-required-outcome'
});

export const ISSUE_SOURCES = Object.freeze({
  CONTROL_MONITORING: 'control-monitoring',
  INCIDENT: 'incident',
  ...
  PRIVACY_ASSESSMENT: 'privacy-assessment',
  AI_EVALUATION: 'ai-evaluation',
  DATA_QUALITY_CONTROL: 'data-quality-control',
  SERVICE_REVIEW: 'service-review',
  CONTINUITY_EXERCISE: 'continuity-exercise',
  ...
  CUSTOMER_ASSESSMENT: 'customer-assessment',
  REGULATORY_EXAMINATION: 'regulatory-examination',
  WHISTLEBLOWING_OR_COMPLAINT: 'whistleblowing-or-complaint',
  AUTOMATED_DETECTION: 'automated-detection',
  ARCHITECTURE_REVIEW: 'architecture-review'
});

export const ISSUE_RECORD_FIELDS = Object.freeze({
  ...
  EVIDENCE: 'evidence',
  OWNER: 'owner',
  AFFECTED_OBJECTIVE: 'affected-objective',
  OBLIGATIONS: 'obligations',
  RISKS: 'risks',
  CONTROLS: 'controls',
  SERVICES: 'services',
  ...
  VERIFICATION: 'verification',
  CLOSURE_AUTHORITY: 'closure-authority',
  RELATED_INCIDENTS_PROBLEMS_CHANGES_AND_EXCEPTIONS: 'related-incidents-problems-changes-and-exceptions',
  HISTORY: 'history'
});

export const ISSUE_CLASSIFICATIONS = Object.freeze({
...
export const ISSUE_PRIORITY_FACTORS = Object.freeze({
  ...
  DATA_INTEGRITY: 'data-integrity',
  AI_HARM: 'ai-harm',
  OBLIGATION_SIGNIFICANCE: 'obligation-significance',
  TENANT_AND_PROPERTY_SCOPE: 'tenant-and-property-scope',
  EXPLOITABILITY: 'exploitability',
  DURATION: 'duration',
  LIKELIHOOD: 'likelihood',
  RECURRENCE: 'recurrence',
  CONTROL_DEPENDENCE: 'control-dependence',
  COMPENSATING_CONTROLS: 'compensating-controls',
  DETECTION: 'detection',
  REVERSIBILITY: 'reversibility',
  SUPPLIER_CONCENTRATION: 'supplier-concentration',
...
export const ISSUE_SEVERITY_LEVELS = Object.freeze({
  CRITICAL: 'critical',
  HIGH: 'high',
  MEDIUM: 'medium',
  LOW: 'low'
...
export const ISSUE_LIFECYCLE_STAGES = Object.freeze({
  IDENTIFY_AND_RECORD: 'Identify and Record',
  VALIDATE_EVIDENCE_AND_SCOPE: 'Validate Evidence and Scope',
  CLASSIFY_AND_PRIORITIZE: 'Classify and Prioritize',
  ASSIGN_OWNER: 'Assign Owner',
  CONTAIN_IMMEDIATE_IMPACT: 'Contain Immediate Impact',
  ANALYZE_CAUSE_AND_CONTRIBUTORS: 'Analyze Cause and Contributors',
  DEFINE_REMEDIATION_AND_INTERIM_CONTROLS: 'Define Remediation and Interim Controls',
  AUTHORIZE_AND_IMPLEMENT_CHANGE: 'Authorize and Implement Change',
  VERIFY_AND_RETEST: 'Verify and Retest',
  ACCEPT_RESIDUAL_RISK_OR_CLOSE: 'Accept Residual Risk or Close',
  MONITOR_RECURRENCE_AND_LEARN: 'Monitor Recurrence and Learn'
});
...
export const IMMEDIATE_CONTAINMENT_ACTIONS = Object.freeze({
  DISABLE_ACCESS: 'disable-access',
  SUSPEND_AI_AGENT: 'suspend-ai-agent',
  RESTRICT_TOOL: 'restrict-tool',
  ISOLATE_TENANT_OR_PROPERTY: 'isolate-tenant-or-property',
  STOP_WORKFLOW: 'stop-workflow',
  REVOKE_CREDENTIALS: 'revoke-credentials',
  DISABLE_UNSAFE_DATA_USE: 'disable-unsafe-data-use',
  PAUSE_RELEASE: 'pause-release',
  ACTIVATE_MANUAL_REVIEW: 'activate-manual-review',
  PRESERVE_EVIDENCE: 'preserve-evidence',
  NOTIFY_AFFECTED_OWNERS: 'notify-affected-owners',
  APPLY_TEMPORARY_CONTROL: 'apply-temporary-control',
  ACTIVATE_INCIDENT_RESPONSE: 'activate-incident-response'
});

export const ROOT_CAUSE_ANALYSIS_AREAS = Object.freeze({
  ARCHITECTURE: 'architecture',
  POLICY: 'policy',
  CONTROL_DESIGN: 'control-design',
...
export const CONTRIBUTING_FACTORS = Object.freeze({
  AMBIGUOUS_OWNERSHIP: 'ambiguous-ownership',
  WEAK_POLICY: 'weak-policy',
  INCOMPLETE_APPLICABILITY: 'incomplete-applicability',
  INADEQUATE_CONTROL: 'inadequate-control',
  UNSAFE_DEFAULT: 'unsafe-default',
  POOR_OBSERVABILITY: 'poor-observability',
  MISSING_EVIDENCE: 'missing-evidence',
  AUTOMATION_BIAS: 'automation-bias',
  HUMAN_INTERFACE_WEAKNESS: 'human-interface-weakness',
  ...
  OVERLY_BROAD_AUTHORITY: 'overly-broad-authority',
  REPEATED_EXCEPTION: 'repeated-exception',
  UNMANAGED_TECHNICAL_DEBT: 'unmanaged-technical-debt'
});

export const CORRECTIVE_ACTION_TYPES = Object.freeze({
  CORRECT_CONFIGURATION: 'correct-configuration',
  RESTORE_CONTROL: 'restore-control',
  FIX_DATA: 'fix-data',
  ...
  CORRECT_PROCEDURE: 'correct-procedure',
  COMPLETE_MISSING_EVIDENCE: 'complete-missing-evidence',
  RECONCILE_RECORDS: 'reconcile-records'
});

export const PREVENTIVE_ACTION_TYPES = Object.freeze({
  ARCHITECTURE_IMPROVEMENT: 'architecture-improvement',
  AUTOMATED_VALIDATION: 'automated-validation',
  STRONGER_ISOLATION: 'stronger-isolation',
  BETTER_DEFAULT: 'better-default',
  ...
  BETTER_HUMAN_OVERSIGHT: 'better-human-oversight',
  IMPROVED_TESTING: 'improved-testing',
  CONTROL_REDESIGN: 'control-redesign',
  BROADER_IMPACT_ANALYSIS: 'broader-impact-analysis'
});

export const REMEDIATION_PLAN_FIELDS = Object.freeze({
  ISSUE: 'issue',
  REQUIRED_OUTCOME: 'required-outcome',
  OWNER: 'owner',
  ACTIONS: 'actions',
  IMMEDIATE_CONTAINMENT: 'immediate-containment',
  ROOT_CAUSE_RESPONSE: 'root-cause-response',
  INTERIM_CONTROLS: 'interim-controls',
  DEPENDENCIES: 'dependencies',
  RESOURCES: 'resources',
  MILESTONES: 'milestones',
...
export const REMEDIATION_OWNERSHIP_FIELDS = Object.freeze({
  PLAN: 'plan',
  RESOURCES: 'resources',
  COORDINATION: 'coordination',
  PROGRESS: 'progress',
...
export const REMEDIATION_CHANGE_CONTROL_FACTORS = Object.freeze({
  URGENCY: 'urgency',
  RISK: 'risk',
  SCOPE: 'scope',
...
export const INTERIM_CONTROL_FIELDS = Object.freeze({
  OBJECTIVE: 'objective',
  SCOPE: 'scope',
  OWNER: 'owner',
  OPERATION: 'operation',
  ...
  RISK_REDUCTION: 'risk-reduction',
  EXPIRATION: 'expiration',
  TRANSITION_TO_PERMANENT_CONTROL: 'transition-to-permanent-control'
});

export const REMEDIATION_DEADLINE_FACTORS = Object.freeze({
  SEVERITY: 'severity',
  OBLIGATION: 'obligation',
...
export const OVERDUE_REMEDIATION_REQUIREMENTS = Object.freeze({
  MARK_OVERDUE: 'mark-overdue',
  REASSESS_RESIDUAL_RISK: 'reassess-residual-risk',
  REEVALUATE_CONTROLS: 'reevaluate-existing-controls',
  NOTIFY_RISK_OWNER: 'notify-risk-owner',
  ESCALATE_BY_POLICY: 'escalate-by-policy',
  REVISED_ACTION_REQUIRES_AUTHORITY: 'revised-action-requires-authority',
  CONTINUED_EXPOSURE_REQUIRES_EXCEPTION_OR_ACCEPTANCE: 'continued-exposure-requires-exception-or-acceptance',
  ACCURATE_STAKEHOLDER_REPORTING: 'accurate-stakeholder-reporting'
});

export const REMEDIATION_VALIDATION_CRITERIA = Object.freeze({
  ACTIONS_IMPLEMENTED: 'required-actions-implemented',
  SCOPE_COMPLETE: 'scope-complete',
  ROOT_CAUSES_ADDRESSED: 'root-causes-addressed',
  CONTROLS_OPERATE_EFFECTIVELY: 'controls-operate-effectively',
  EVIDENCE_RELIABLE: 'evidence-reliable',
  NO_UNACCEPTABLE_NEW_RISK: 'no-unacceptable-new-risk',
  TENANT_AND_PROPERTY_BOUNDARIES_PROTECTED: 'tenant-and-property-boundaries-protected',
  TEMPORARY_CONTROLS_CAN_BE_RETIRED: 'temporary-controls-can-be-retired',
  RELATED_OBLIGATIONS_SATISFIED: 'related-obligations-satisfied',
  RECURRENCE_REDUCED: 'recurrence-reduced'
});

export const RETEST_FIELDS = Object.freeze({
  CRITERIA: 'criteria',
  SCOPE: 'scope',
  POPULATION: 'population',
  METHOD: 'method',
...
export const ISSUE_CLOSURE_REQUIREMENTS = Object.freeze({
  REMEDIATION_COMPLETED: 'remediation-completed',
  VALIDATION_PERFORMED: 'validation-performed',
  RETEST_PASSED: 'retest-passed-where-required',
  EVIDENCE_RETAINED: 'evidence-retained',
  RESIDUAL_RISK_ASSESSED: 'residual-risk-assessed',
  TEMPORARY_CONTROLS_DISPOSITIONED: 'temporary-controls-dispositioned',
  RELATED_EXCEPTIONS_CLOSED_OR_UPDATED: 'related-exceptions-closed-or-updated',
  STAKEHOLDERS_INFORMED: 'stakeholders-informed',
  CLOSURE_AUTHORITY_APPROVAL: 'closure-authority-approval',
  MONITORING_DEFINED: 'monitoring-defined'
});

export const CLOSURE_AUTHORITY_FACTORS = Object.freeze({
  ...
  AI_IMPACT: 'ai-impact',
  TENANT_SCOPE: 'tenant-scope',
  AUDITOR_OR_REGULATOR_REQUIREMENT: 'auditor-or-regulator-requirement',
  ASSURANCE_INDEPENDENCE: 'assurance-independence'
});

export const RISK_ACCEPTANCE_REQUIREMENTS = Object.freeze({
  REMEDIATION_NOT_MANDATORY: 'remediation-not-mandatory-under-obligation',
  RESIDUAL_RISK_UNDERSTOOD: 'residual-risk-understood',
  VALID_ACCEPTANCE_AUTHORITY: 'valid-acceptance-authority',
  EVIDENCE_SUPPORTS_DECISION: 'evidence-supports-decision',
  SCOPE_AND_DURATION_DEFINED: 'scope-and-duration-defined',
  MONITORING_EXISTS: 'monitoring-exists',
  STAKEHOLDERS_INFORMED: 'stakeholders-informed',
  REASSESSMENT_TRIGGERS_DEFINED: 'reassessment-triggers-defined'
});

export const REOPENING_TRIGGERS = Object.freeze({
  REMEDIATION_INEFFECTIVE: 'remediation-proves-ineffective',
  ISSUE_RECURS: 'issue-recurs',
  SCOPE_INCOMPLETE: 'scope-was-incomplete',
  EVIDENCE_INCORRECT: 'evidence-was-incorrect',
  RELATED_CONTROL_FAILS: 'related-control-fails',
  NEW_IMPACT_EMERGES: 'new-impact-emerges',
  SUPPLIER_OR_TENANT_CONDITION_CHANGES: 'supplier-or-tenant-condition-changes',
  CLOSURE_CONDITIONS_NOT_MET: 'closure-conditions-not-met'
});

export const RECURRING_ISSUE_RESPONSE_ACTIONS = Object.freeze({
  BROADER_PROBLEM_ANALYSIS: 'broader-problem-analysis',
  ARCHITECTURE_REVIEW: 'architecture-review',
  POLICY_REVIEW: 'policy-review',
  CONTROL_FRAMEWORK_REVIEW: 'control-framework-review',
  ASSURANCE_REVIEW: 'assurance-review',
  SUPPLIER_REVIEW: 'supplier-review',
  TENANT_PATTERN_ANALYSIS: 'tenant-pattern-analysis',
  PROPERTY_PATTERN_ANALYSIS: 'property-pattern-analysis',
  TRAINING_AND_INCENTIVE_REVIEW: 'training-and-incentive-review',
  GOVERNANCE_ESCALATION: 'governance-escalation'
});

export const SYSTEMIC_ISSUE_SCOPES = Object.freeze({
  SERVICES: 'services',
  CONTROLS: 'controls',
  TENANTS: 'tenants',
  PROPERTIES: 'properties',
...
export const UNAUTHORIZED_CONDITION_ACTIONS = Object.freeze({
  RECORD: 'record',
  CONTAIN: 'contain-where-necessary',
  ASSESS: 'assess',
  ESCALATE: 'escalate',
  EVIDENCE: 'evidence',
  REMEDIATE: 'remediate',
  REVIEW_CAUSE: 'review-for-cause',
  EVALUATE_MISCONDUCT_OR_CONTROL_FAILURE: 'evaluate-misconduct-or-control-failure'
});

export const DOMAIN_ISSUE_AREAS = Object.freeze({
...
export const REMEDIATION_EVIDENCE_TYPES = Object.freeze({
  ...
  CONFIGURATION: 'configuration',
  CODE_OR_ARCHITECTURE: 'code-or-architecture',
  ...
  PROPERTY_RECONCILIATION: 'property-reconciliation',
  TRAINING: 'training',
  INDEPENDENT_ASSURANCE: 'independent-assurance',
  MONITORING: 'monitoring'
});

export const ISSUE_MANAGEMENT_RESPONSE_FIELDS = Object.freeze({
  AGREEMENT_OR_DISAGREEMENT: 'agreement-or-disagreement',
  EVIDENCE: 'evidence',
  RISK_VIEW: 'risk-view',
  CONTAINMENT: 'containment',
  ...
  DEPENDENCIES: 'dependencies',
  ACCEPTANCE_PROPOSAL: 'acceptance-proposal-if-applicable'
});

export const ISSUE_REPORT_FIELDS = Object.freeze({
  ...
  REPEATED_ISSUES: 'repeated-issues',
...
export const EXCEPTIONS_ISSUES_REMEDIATION_MEASURES = Object.freeze({
  ACTIVE_EXCEPTIONS: 'active-exceptions',
  EXCEPTION_AGE: 'exception-age',
  EXPIRED_EXCEPTIONS: 'expired-exceptions',
  REPEATED_EXTENSIONS: 'repeated-extensions',
  OPEN_ISSUES: 'open-issues',
  ISSUE_AGE: 'issue-age',
  OVERDUE_REMEDIATION: 'overdue-remediation',
  CRITICAL_AND_HIGH_FINDINGS: 'critical-and-high-findings',
  REPEAT_FINDINGS: 'repeat-findings',
  REOPENED_ISSUES: 'reopened-issues',
  AVERAGE_CONTAINMENT_TIME: 'average-containment-time',
  REMEDIATION_COMPLETION: 'remediation-completion',
  RETEST_SUCCESS: 'retest-success',
  RISK_ACCEPTANCE: 'risk-acceptance',
  SUPPLIER_ISSUES: 'supplier-issues',
  TENANT_AND_PROPERTY_ISSUES: 'tenant-and-property-issues',
  AI_AND_PRIVACY_ISSUES: 'ai-and-privacy-issues',
  CLOSURE_VALIDATION: 'closure-validation',
  SYSTEMIC_REMEDIATION_PROGRESS: 'systemic-remediation-progress'
});

export const EXCEPTIONS_ISSUES_REMEDIATION_GOVERNANCE_AREAS = Object.freeze({
...
export const EXCEPTIONS_ISSUES_REMEDIATION_QUALITY_ATTRIBUTES = Object.freeze({
  ACCOUNTABILITY: 'accountability',
  TRANSPARENCY: 'transparency',
  TRACEABILITY: 'traceability',
  RESILIENCE: 'resilience',
...
export const EXCEPTIONS_ISSUES_REMEDIATION_ARCHITECTURAL_RULES = Object.freeze({
  TREAT_EXCEPTIONS_AS_TEMPORARY_AND_AUTHORIZED: 'treat-exceptions-as-temporary-and-authorized',
  PROHIBIT_INTERNAL_EXCEPTION_OVERRIDE_OF_BINDING_OBLIGATIONS: 'prohibit-internal-exceptions-from-overriding-binding-obligations-without-qualified-authority',
  SCOPE_EXCEPTIONS_NARROWLY: 'scope-exceptions-narrowly',
  REQUIRE_COMPENSATING_CONTROLS_AND_MONITORING: 'require-compensating-controls-and-monitoring',
  ENFORCE_EXPIRATION_AND_REVIEW: 'enforce-expiration-and-review',
  ASSIGN_ONE_ACCOUNTABLE_OWNER_TO_EVERY_ISSUE: 'assign-one-accountable-owner-to-every-issue',
  CLASSIFY_AND_PRIORITIZE_BY_BUSINESS_AND_RISK_IMPACT: 'classify-and-prioritize-using-business-and-risk-impact',
  CONTAIN_IMMEDIATE_HARM_BEFORE_CORRECTION: 'contain-immediate-harm-before-long-term-correction',
  ANALYZE_ROOT_CAUSES_AND_CONTRIBUTING_FACTORS: 'analyze-root-causes-and-contributing-factors',
  GOVERN_REMEDIATION_THROUGH_CONTROLLED_CHANGE: 'govern-remediation-through-controlled-change',
  DEFINE_INTERIM_CONTROLS_WHEN_DELAYED: 'define-interim-controls-when-remediation-is-delayed',
  TREAT_OVERDUE_ACTIONS_AS_RISK_DECISIONS: 'treat-overdue-actions-as-risk-decisions',
  VERIFY_OUTCOMES_BEFORE_CLOSURE: 'verify-outcomes-and-control-effectiveness-before-closure',
  SEPARATE_REMEDIATION_EXECUTION_FROM_CLOSURE_AUTHORITY: 'separate-remediation-execution-from-closure-authority-when-risk-requires',
  PRESERVE_HISTORY_WHEN_REOPENED: 'preserve-history-when-issues-reopen',
  ESCALATE_RECURRING_AND_SYSTEMIC_ISSUES: 'escalate-recurring-and-systemic-issues',
  COVER_ENTERPRISE_ISSUE_DOMAINS: 'cover-security-privacy-data-ai-suppliers-tenants-properties-and-evidence',
  PRESERVE_TENANT_AND_PROPERTY_BOUNDARIES: 'preserve-tenant-and-property-boundaries',
  PREVENT_UNSUPPORTED_RETROSPECTIVE_APPROVAL: 'prevent-unsupported-retrospective-approval',
  REMAIN_VENDOR_AND_TECHNOLOGY_NEUTRAL: 'remain-vendor-neutral-and-technology-independent'
});

export const FUTURE_EXCEPTIONS_ISSUES_REMEDIATION_CAPABILITIES = Object.freeze({
  AUTOMATED_EXCEPTION_EXPIRATION_ENFORCEMENT: 'automated-exception-expiration-enforcement',
  PREDICTIVE_ISSUE_RECURRENCE: 'predictive-issue-recurrence',
  AI_ASSISTED_ROOT_CAUSE_ANALYSIS: 'ai-assisted-root-cause-analysis',
  SEMANTIC_FINDING_CORRELATION: 'semantic-finding-correlation',
  DYNAMIC_REMEDIATION_PRIORITY: 'dynamic-remediation-priority',
  CONTINUOUS_REMEDIATION_VERIFICATION: 'continuous-remediation-verification',
  CROSS_PROPERTY_ISSUE_INTELLIGENCE: 'cross-property-issue-intelligence',
  SUPPLIER_REMEDIATION_MONITORING: 'supplier-remediation-monitoring',
  MACHINE_READABLE_CLOSURE_CRITERIA: 'machine-readable-closure-criteria',
  AUTOMATED_COMPENSATING_CONTROLS: 'automated-compensating-controls',
  REMEDIATION_DIGITAL_TWINS: 'remediation-digital-twins',
  GOVERNED_AUTONOMOUS_LOW_RISK_CORRECTION: 'governed-autonomous-low-risk-correction',
  REAL_TIME_RESIDUAL_RISK_UPDATES: 'real-time-residual-risk-updates'
});

export const FUTURE_GOVERNANCE_VISION_CAPABILITIES = Object.freeze({
  UNDERSTAND_ENTERPRISE_PURPOSE_AND_OBLIGATIONS: 'understand-enterprise-purpose-and-obligations',
  MAINTAIN_EXPLICIT_ACCOUNTABILITY: 'maintain-explicit-accountability',
  DETERMINE_APPLICABILITY_BY_CONTEXT: 'determine-applicability-by-context',
  TRANSLATE_OBLIGATIONS: 'translate-obligations-into-policy-and-control-objectives',
  EVALUATE_RISK_CONTINUOUSLY: 'evaluate-risk-continuously',
  ENFORCE_AUTHORIZED_DECISION_BOUNDARIES: 'enforce-authorized-decision-boundaries',
  GENERATE_AND_CORRELATE_EVIDENCE: 'generate-and-correlate-evidence',
  DETECT_CONTROL_AND_COMPLIANCE_DRIFT: 'detect-control-and-compliance-drift',
  PROVIDE_CURRENT_GOVERNANCE_POSTURE: 'provide-current-governance-posture',
  SUPPORT_INDEPENDENT_ASSURANCE: 'support-independent-assurance',
  COORDINATE_REMEDIATION: 'coordinate-remediation',
  ADAPT_ACROSS_CONTEXTS: 'adapt-across-tenants-properties-and-jurisdictions',
  EXPLAIN_DECISIONS_AND_LIMITATIONS: 'explain-decisions-and-limitations',
  ESCALATE_TO_QUALIFIED_HUMANS: 'escalate-to-qualified-humans',
  LEARN_THROUGH_GOVERNED_CHANGE: 'learn-through-governed-change'
});

export const GOVERNANCE_EVOLUTION_DRIVERS = Object.freeze({
  TENANT_AND_PROPERTY_GROWTH: 'growth-in-tenants-and-properties',
  JURISDICTION_EXPANSION: 'expansion-across-jurisdictions',
  INCREASING_AI_AUTONOMY: 'increasing-ai-autonomy',
  MULTI_AGENT_SYSTEMS: 'multi-agent-systems',
  NEW_DATA_USES: 'new-data-uses',
  ADDITIONAL_SUPPLIERS_AND_PLUGINS: 'additional-suppliers-and-plugins',
  REGULATORY_CHANGE: 'regulatory-change',
  GREATER_ASSURANCE_DEMANDS: 'greater-assurance-demands',
  FREQUENT_ARCHITECTURE_CHANGE: 'more-frequent-architecture-change',
  SERVICE_COMPLEXITY: 'increased-service-complexity',
  CROSS_BORDER_OPERATION: 'cross-border-operation',
  TRUST_EXPECTATIONS: 'customer-and-tenant-trust-expectations',
  FASTER_PRODUCT_DELIVERY: 'need-for-faster-product-delivery',
  HIGHER_EVIDENCE_VOLUME: 'higher-evidence-volume',
  OPERATIONAL_COST_PRESSURE: 'operational-cost-pressure',
  CONTINUOUS_COMPLIANCE_POSTURE: 'demand-for-continuous-compliance-posture'
});

export const FUTURE_GOVERNANCE_EVOLUTION_PRINCIPLES = Object.freeze({
  PRESERVE_HUMAN_ACCOUNTABILITY: 'preserve-human-accountability',
  QUALIFIED_INTERPRETATION_REMAINS_ESSENTIAL: 'qualified-interpretation-remains-essential',
  AUTOMATE_PROVEN_GOVERNANCE: 'automate-proven-governance',
  INCREASE_AUTHORITY_GRADUALLY: 'increase-authority-gradually',
  EVIDENCE_REMAINS_VERIFIABLE: 'evidence-must-remain-verifiable',
  GOVERNANCE_REMAINS_EXPLAINABLE: 'governance-must-remain-explainable',
  PRESERVE_FEDERATION_AND_ISOLATION: 'preserve-federation-and-isolation',
  AVOID_FRAMEWORK_LOCK_IN: 'avoid-framework-lock-in'
});

export const GOVERNANCE_EVOLUTION_MATURITY_STAGES = Object.freeze({
  REACTIVE_GOVERNANCE: 'reactive-governance',
  STANDARDIZED_GOVERNANCE: 'standardized-governance',
  INTEGRATED_GOVERNANCE: 'integrated-governance',
  MEASURED_GOVERNANCE: 'measured-governance',
  PROACTIVE_GOVERNANCE: 'proactive-governance',
  ADAPTIVE_GOVERNANCE: 'adaptive-governance',
  BOUNDED_AUTONOMOUS_GOVERNANCE: 'bounded-autonomous-governance',
  GOVERNED_SELF_IMPROVING_GOVERNANCE: 'governed-self-improving-governance'
});

export const SEMANTIC_GOVERNANCE_CONCEPTS = Object.freeze({
  OBJECTIVE: 'objective',
  PRINCIPLE: 'principle',
  OBLIGATION: 'obligation',
  INTERPRETATION: 'interpretation',
...
export const GOVERNANCE_KNOWLEDGE_GRAPH_STAGES = Object.freeze({
  OBLIGATION: 'Obligation',
  INTERPRETATION: 'Interpretation',
  POLICY_REQUIREMENT: 'Policy Requirement',
  CONTROL_OBJECTIVE: 'Control Objective',
  CONTROL_IMPLEMENTATION: 'Control Implementation',
  EXECUTION_SCOPE: 'Service, Data, AI, Workflow, Supplier, Tenant, or Property',
  EVIDENCE: 'Evidence',
  ASSURANCE_RESULT: 'Assurance Result',
  POSTURE_RESULT: 'Finding, Exception, or Verified Posture'
});

export const MACHINE_READABLE_OBLIGATION_FIELDS = Object.freeze({
  SOURCE: 'source',
  AUTHORITY: 'authority',
  JURISDICTION: 'jurisdiction',
  REQUIREMENT: 'requirement',
...
export const OBLIGATION_CHANGE_INTELLIGENCE_CAPABILITIES = Object.freeze({
  DETECT_CHANGED_SOURCES: 'detect-changed-sources',
  COMPARE_VERSIONS: 'compare-versions',
  IDENTIFY_AFFECTED_INTERPRETATIONS: 'identify-affected-interpretations',
  MAP_AFFECTED_POLICIES: 'map-affected-policies',
  IDENTIFY_AFFECTED_CONTROLS: 'identify-affected-controls',
  IDENTIFY_AFFECTED_EXECUTION_SCOPES: 'identify-services-data-ai-suppliers-tenants-and-properties',
  ESTIMATE_IMPLEMENTATION_GAPS: 'estimate-implementation-gaps',
  PROPOSE_ACTION: 'propose-action',
  TRACK_EFFECTIVE_DATES: 'track-effective-dates'
});

export const DYNAMIC_APPLICABILITY_CONTEXTS = Object.freeze({
  ENTITY: 'entity',
  JURISDICTION: 'jurisdiction',
  TENANT: 'tenant',
  PROPERTY: 'property',
...
export const FUTURE_EXECUTABLE_POLICY_USES = Object.freeze({
  ACCESS_DECISIONS: 'access-decisions',
  AI_TOOL_AUTHORIZATION: 'ai-tool-authorization',
  DATA_USE_DECISIONS: 'data-use-decisions',
  TENANT_CONFIGURATION: 'tenant-configuration',
  CHANGE_APPROVAL: 'change-approval',
  RETENTION: 'retention',
  RESIDENCY: 'residency',
...
export const POLICY_SIMULATION_FACTORS = Object.freeze({
  AFFECTED_USERS: 'affected-users',
  ...
  ENFORCEMENT_READINESS: 'enforcement-readiness'
});

export const FUTURE_POLICY_CONFLICT_TYPES = Object.freeze({
  CONTRADICTORY_REQUIREMENTS: 'contradictory-requirements',
  OVERLAPPING_POLICIES: 'overlapping-policies',
  CONFLICTING_JURISDICTIONS: 'conflicting-jurisdictions',
  TENANT_POLICY_CONFLICTS: 'tenant-policy-conflicts',
  PROPERTY_PROCEDURE_CONFLICTS: 'property-procedure-conflicts',
  SECURITY_PRIVACY_TENSION: 'security-and-privacy-tension',
  AI_POLICY_INCONSISTENCIES: 'ai-policy-inconsistencies',
  EXPIRED_RULES: 'expired-rules',
  IMPLEMENTATION_DIVERGENCE: 'implementation-divergence'
});

export const CONTINUOUS_CONTROL_VERIFICATION_TARGETS = Object.freeze({
...
export const CONTROL_DRIFT_SOURCES = Object.freeze({
...
export const FUTURE_CONTINUOUS_COMPLIANCE_COMPONENTS = Object.freeze({
  OBLIGATION_MONITORING: 'obligation-monitoring',
  APPLICABILITY: 'applicability',
  POLICY_EVALUATION: 'policy-evaluation',
  CONTROL_VERIFICATION: 'control-verification',
  EVIDENCE_CORRELATION: 'evidence-correlation',
...
export const REAL_TIME_GOVERNANCE_POSTURE_FIELDS = Object.freeze({
  APPLICABLE_OBLIGATIONS: 'applicable-obligations',
  POLICY_STATUS: 'policy-status',
...
export const PREDICTIVE_RISK_GOVERNANCE_SIGNALS = Object.freeze({
  INCIDENT_TRENDS: 'incident-trends',
  CHANGE_TRENDS: 'change-trends',
  CONTROL_FAILURES: 'control-failures',
  FINDINGS: 'findings',
  EXCEPTION_GROWTH: 'exception-growth',
  SUPPLIER_SIGNALS: 'supplier-signals',
  AI_DRIFT: 'ai-drift',
  DATA_QUALITY_TRENDS: 'data-quality-trends',
  CAPACITY: 'capacity',
  TENANT_PATTERNS: 'tenant-patterns',
  PROPERTY_PATTERNS: 'property-patterns',
  THREAT_INTELLIGENCE: 'threat-intelligence',
  REGULATORY_CHANGE: 'regulatory-change'
});

export const PRESCRIPTIVE_RISK_RECOMMENDATIONS = Object.freeze({
  CONTROL_STRENGTHENING: 'control-strengthening',
  INCREASED_ASSURANCE: 'increased-assurance',
  CHANGE_RESTRICTION: 'change-restriction',
  SUPPLIER_REVIEW: 'supplier-review',
  TENANT_INTERVENTION: 'tenant-intervention',
  AI_AUTONOMY_REDUCTION: 'ai-autonomy-reduction',
  PRIVACY_ASSESSMENT: 'privacy-assessment',
  CAPACITY_RESERVATION: 'capacity-reservation',
  CONTINUITY_TESTING: 'continuity-testing',
  REMEDIATION_PRIORITY: 'remediation-priority',
  RISK_ESCALATION: 'risk-escalation'
});

export const AI_ASSISTED_GOVERNANCE_USES = Object.freeze({
  OBLIGATION_SUMMARIZATION: 'obligation-summarization',
  POLICY_DRAFTING: 'policy-drafting',
  CONTROL_MAPPING: 'control-mapping',
  EVIDENCE_CORRELATION: 'evidence-correlation',
  RISK_IDENTIFICATION: 'risk-identification',
  ASSURANCE_PLANNING: 'assurance-planning',
  FINDING_CORRELATION: 'finding-correlation',
  REMEDIATION_ANALYSIS: 'remediation-analysis',
  GOVERNANCE_REPORTING: 'governance-reporting',
  TENANT_SPECIFIC_IMPACT: 'tenant-specific-impact',
  SUPPLIER_REVIEW: 'supplier-review',
  ARCHITECTURE_IMPACT_ANALYSIS: 'architecture-impact-analysis'
});

export const GOVERNANCE_AGENT_SPECIALIZATIONS = Object.freeze({
  POLICY: 'policy',
  RISK: 'risk',
  CONTROLS: 'controls',
  PRIVACY: 'privacy',
...
export const GOVERNANCE_AGENT_REQUIREMENTS = Object.freeze({
  IDENTITY: 'identity',
  OWNERSHIP: 'ownership',
  PURPOSE: 'purpose',
  PERMISSIONS: 'permissions',
...
export const AUTONOMOUS_GOVERNANCE_SUITABILITY_CRITERIA = Object.freeze({
  EXPLICITLY_AUTHORIZED: 'explicitly-authorized',
  LOW_RISK: 'low-risk',
  DETERMINISTIC_OR_WELL_EVALUATED: 'deterministic-or-well-evaluated',
  BOUNDED: 'bounded',
  REVERSIBLE: 'reversible',
  TENANT_ISOLATED: 'tenant-isolated',
  EVIDENCE_GENERATING: 'evidence-generating',
...
export const AUTONOMOUS_GOVERNANCE_EXAMPLES = Object.freeze({
  EXPIRING_EXCEPTION: 'expiring-an-exception',
  DISABLING_NONCOMPLIANT_CONFIGURATION: 'disabling-a-noncompliant-configuration',
  REQUESTING_MISSING_EVIDENCE: 'requesting-missing-evidence',
  RESTRICTING_UNAUTHORIZED_AI_TOOL: 'restricting-an-unauthorized-ai-tool',
  OPENING_FINDING: 'opening-a-finding',
  SCHEDULING_CONTROL_RETEST: 'scheduling-a-control-retest',
  APPLYING_APPROVED_RETENTION_RULE: 'applying-an-approved-retention-rule'
});

export const AUTONOMOUS_REMEDIATION_ACTIONS = Object.freeze({
  CORRECT_APPROVED_CONFIGURATION_DRIFT: 'correct-approved-configuration-drift',
  REVOKE_EXPIRED_ACCESS: 'revoke-expired-access',
  RESTORE_STANDARD_CONTROL: 'restore-standard-control',
  QUARANTINE_UNSAFE_AUTOMATION: 'quarantine-unsafe-automation',
  APPLY_APPROVED_DATA_RETENTION_ACTION: 'apply-approved-data-retention-action',
  REVERT_UNAUTHORIZED_SETTING: 'revert-unauthorized-setting',
  STOP_EXPIRED_EXCEPTION: 'stop-expired-exception',
  COLLECT_REQUIRED_EVIDENCE: 'collect-required-evidence'
});

export const AUTONOMOUS_REMEDIATION_FIELDS = Object.freeze({
  AUTHORITY: 'authority',
  TARGET: 'target',
  SCOPE: 'scope',
  RISK: 'risk',
...
export const CONTINUOUS_ASSURANCE_ADAPTATION_FACTORS = Object.freeze({
  RISK: 'risk',
  ...
  OBLIGATION_CHANGE: 'obligation-change',
  INCIDENT: 'incident',
  EXCEPTION: 'exception'
});

export const DYNAMIC_AUDIT_PLANNING_FACTORS = Object.freeze({
  RISK_POSTURE: 'risk-posture',
  ASSURANCE_COVERAGE: 'assurance-coverage',
  CONTROL_FAILURES: 'control-failures',
  EMERGING_OBLIGATIONS: 'emerging-obligations',
  SUPPLIER_CONCENTRATION: 'supplier-concentration',
  AI_AUTONOMY: 'ai-autonomy',
  DATA_SENSITIVITY: 'data-sensitivity',
  TENANT_IMPACT: 'tenant-impact',
...
export const PRIVACY_PRESERVING_ASSURANCE_METHODS = Object.freeze({
  DATA_MINIMIZATION: 'data-minimization',
  AGGREGATION: 'aggregation',
  PSEUDONYMIZATION: 'pseudonymization',
  SECURE_COMPUTATION: 'secure-computation',
  SELECTIVE_DISCLOSURE: 'selective-disclosure',
  PROOF_OF_CONTROL_OUTCOME: 'proof-of-control-outcome',
  TENANT_ISOLATED_EVIDENCE: 'tenant-isolated-evidence',
  ROLE_BASED_EVIDENCE_VIEWS: 'role-based-evidence-views'
});

export const MACHINE_READABLE_ATTESTATION_FIELDS = Object.freeze({
  ATTESTOR: 'attestor',
  AUTHORITY: 'authority',
  SCOPE: 'scope',
  CRITERIA: 'criteria',
...
export const FEDERATED_TENANT_GOVERNANCE_REQUIREMENTS = Object.freeze({
  MANDATORY_ENTERPRISE_CONTROLS: 'mandatory-enterprise-controls',
  TENANT_AUTHORITY: 'tenant-authority',
  TENANT_ISOLATION: 'tenant-isolation',
  TENANT_SPECIFIC_OBLIGATIONS: 'tenant-specific-obligations',
  PROPERTY_DELEGATION: 'property-delegation',
  EVIDENCE_ACCESS: 'evidence-access',
...
export const PROPERTY_GOVERNANCE_INTELLIGENCE_CAPABILITIES = Object.freeze({
  LOCAL_OBLIGATION_MAPPING: 'local-obligation-mapping',
  PROCEDURE_VALIDATION: 'procedure-validation',
  STAFF_CONTROL_EVIDENCE: 'staff-control-evidence',
  PHYSICAL_CONTROL_ASSESSMENT: 'physical-control-assessment',
  PROPERTY_CONTINUITY: 'property-continuity',
  LOCAL_DATA_HANDLING: 'local-data-handling',
  GUEST_IMPACT_GOVERNANCE: 'guest-impact-governance',
  AUTOMATED_RECONCILIATION: 'automated-reconciliation',
  TENANT_REPORTING: 'tenant-reporting'
});

export const SUPPLIER_PLUGIN_GOVERNANCE_CAPABILITIES = Object.freeze({
  AUTOMATED_INVENTORY: 'automated-inventory',
  CAPABILITY_AND_PERMISSION_CLASSIFICATION: 'capability-and-permission-classification',
...
export const GOVERNANCE_DIGITAL_TWIN_USES = Object.freeze({
  OBLIGATION_CHANGE_IMPACT: 'obligation-change-impact',
  POLICY_CHANGE_IMPACT: 'policy-change-impact',
  CONTROL_FAILURE_PROPAGATION: 'control-failure-propagation',
  RISK_AGGREGATION: 'risk-aggregation',
  AUDIT_PLANNING: 'audit-planning',
  TENANT_ONBOARDING: 'tenant-onboarding',
  JURISDICTION_EXPANSION: 'jurisdiction-expansion',
  AI_AUTONOMY_SIMULATION: 'ai-autonomy-simulation',
  SUPPLIER_LOSS_ANALYSIS: 'supplier-loss-analysis',
  REMEDIATION_SEQUENCING: 'remediation-sequencing'
});

export const GOVERNANCE_MEMORY_ITEMS = Object.freeze({
  DECISIONS: 'decisions',
...
export const GOVERNANCE_HUMAN_STRENGTHS = Object.freeze({
  ENTERPRISE_PURPOSE: 'enterprise-purpose',
  LEGAL_INTERPRETATION: 'legal-interpretation',
  ETHICAL_JUDGMENT: 'ethical-judgment',
  POLICY_AUTHORITY: 'policy-authority',
  RISK_APPETITE: 'risk-appetite',
  RISK_ACCEPTANCE: 'risk-acceptance',
  HIGH_IMPACT_EXCEPTION: 'high-impact-exception',
  INDEPENDENT_ASSURANCE: 'independent-assurance',
  AUDIT_JUDGMENT: 'audit-judgment',
  STAKEHOLDER_TRUST: 'stakeholder-trust',
  RECOURSE: 'recourse',
  ARCHITECTURE_DECISIONS: 'architecture-decisions'
});

export const GOVERNANCE_MACHINE_STRENGTHS = Object.freeze({
  CONTINUOUS_MONITORING: 'continuous-monitoring',
  TRACEABILITY: 'traceability',
  CORRELATION: 'correlation',
  REPETITIVE_EVALUATION: 'repetitive-evaluation',
  EVIDENCE_COLLECTION: 'evidence-collection',
  DRIFT_DETECTION: 'drift-detection',
  IMPACT_ANALYSIS: 'impact-analysis',
  SIMULATION: 'simulation',
  BOUNDED_ENFORCEMENT: 'bounded-enforcement',
  REPORTING_SUPPORT: 'reporting-support'
});

export const FUTURE_GOVERNANCE_TRUST_FACTORS = Object.freeze({
  IDENTITY: 'identity',
  AUTHORITY: 'authority',
  COMPETENCE: 'competence',
  INDEPENDENCE: 'independence',
...
export const FUTURE_GOVERNANCE_EXPLAINABILITY_FIELDS = Object.freeze({
  APPLIED_OBLIGATION_OR_POLICY: 'applied-obligation-or-policy',
  ...
  UNCERTAINTY: 'uncertainty',
  OUTCOME: 'outcome',
  EXCEPTION_OR_APPEAL: 'exception-or-appeal',
  REVIEW_TIME: 'review-time'
});

export const GOVERNANCE_SELF_IMPROVEMENT_TARGETS = Object.freeze({
  POLICIES: 'policies',
  CONTROL_OBJECTIVES: 'control-objectives',
...
export const FUTURE_GOVERNANCE_ARCHITECTURE_RELATIONSHIPS = Object.freeze({
  ...
  ARCH_016_KNOWLEDGE_MEMORY: 'ARCH-016 Knowledge & Memory',
  ARCH_017_API_SDK_ARCHITECTURE: 'ARCH-017 API & SDK Architecture',
  ARCH_018_MULTI_TENANCY: 'ARCH-018 Multi-Tenancy',
  ARCH_019_PLUGIN_EXTENSION_FRAMEWORK: 'ARCH-019 Plugin & Extension Framework',
  ARCH_020_REFERENCE_IMPLEMENTATIONS: 'ARCH-020 Reference Implementations'
});

export const FUTURE_GOVERNANCE_TRANSITION_CRITERIA = Object.freeze({
  ACCOUNTABLE_OWNERSHIP_EXISTS: 'accountable-ownership-exists',
  AUTHORITY_EXPLICIT: 'authority-is-explicit',
  POLICY_STABLE_ENOUGH: 'policy-is-stable-enough',
  CRITERIA_TESTABLE: 'criteria-are-testable',
  EVIDENCE_RELIABLE: 'evidence-is-reliable',
  RISK_UNDERSTOOD: 'risk-is-understood',
  SECURITY_PRIVACY_CONTROLS_EFFECTIVE: 'security-and-privacy-controls-are-effective',
  TENANT_BOUNDARIES_ENFORCEABLE: 'tenant-boundaries-are-enforceable',
  OUTCOMES_EXPLAINABLE: 'outcomes-are-explainable',
  ACTIONS_REVERSIBLE_OR_CONTAINABLE: 'actions-are-reversible-or-containable',
  HUMAN_ESCALATION_EXISTS: 'human-escalation-exists',
  INDEPENDENT_ASSURANCE_PROPORTIONATE: 'independent-assurance-is-proportionate',
  PERFORMANCE_DEMONSTRATED: 'performance-is-demonstrated',
  RECOURSE_AVAILABLE: 'recourse-is-available-where-appropriate',
  CHANGE_GOVERNED: 'change-is-governed'
});

export const FUTURE_GOVERNANCE_EVOLUTION_RISKS = Object.freeze({
  AUTOMATION_BIAS: 'automation-bias',
  INCORRECT_OBLIGATION_INTERPRETATION: 'incorrect-obligation-interpretation',
  FALSE_COMPLIANCE_CONFIDENCE: 'false-compliance-confidence',
  OPAQUE_POLICY_DECISIONS: 'opaque-policy-decisions',
  CROSS_TENANT_LEAKAGE: 'cross-tenant-leakage',
  EXCESSIVE_SURVEILLANCE: 'excessive-surveillance',
  EVIDENCE_OVERCOLLECTION: 'evidence-overcollection',
  AI_FABRICATED_EVIDENCE: 'ai-fabricated-evidence',
  CASCADING_AUTOMATED_ENFORCEMENT: 'cascading-automated-enforcement',
  POLICY_CONFLICT: 'policy-conflict',
  UNCONTROLLED_SELF_MODIFICATION: 'uncontrolled-self-modification',
  LOSS_OF_AUDITOR_INDEPENDENCE: 'loss-of-auditor-independence',
  PROVIDER_LOCK_IN: 'provider-lock-in',
  REGULATORY_MISMATCH: 'regulatory-mismatch',
  DISCRIMINATORY_OUTCOMES: 'discriminatory-outcomes',
  INACCESSIBLE_RECOURSE: 'inaccessible-recourse',
  OPTIMIZATION_AGAINST_INCOMPLETE_METRICS: 'optimization-against-incomplete-metrics'
});

export const AUTOMATED_GOVERNANCE_FAILURE_HANDLING = Object.freeze({
  STOP_OR_CONTAINMENT: 'stop-or-containment',
  AUTHORITY_REVOCATION: 'authority-revocation',
  PRESERVE_EVIDENCE: 'preservation-of-evidence',
  HUMAN_ESCALATION: 'human-escalation',
  SCOPE_ASSESSMENT: 'scope-assessment',
  TENANT_AND_INDIVIDUAL_IMPACT_ASSESSMENT: 'tenant-and-individual-impact-assessment',
  CORRECTION_OR_REVERSAL: 'correction-or-reversal',
...
export const GOVERNANCE_EVOLUTION_LIFECYCLE_STAGES = Object.freeze({
  IDENTIFY_GOVERNANCE_NEED: 'Identify Governance Need',
  ASSESS_VALUE_RISK_AND_OBLIGATION: 'Assess Value, Risk, and Obligation',
  DESIGN_HUMAN_AND_MACHINE_RESPONSIBILITIES: 'Design Human and Machine Responsibilities',
  DEFINE_AUTHORITY_CONTROLS_EVIDENCE_AND_RECOURSE: 'Define Authority, Controls, Evidence, and Recourse',
  EVALUATE_AND_ASSURE: 'Evaluate and Assure',
  INTRODUCE_PROGRESSIVELY: 'Introduce Progressively',
  MONITOR_OUTCOMES_AND_DRIFT: 'Monitor Outcomes and Drift',
  RESTRICT_IMPROVE_EXPAND_OR_RETIRE: 'Restrict, Improve, Expand, or Retire'
});

export const FUTURE_GOVERNANCE_LONG_TERM_QUALITY_ATTRIBUTES = Object.freeze({
  ACCOUNTABILITY: 'accountability',
  TRACEABILITY: 'traceability',
  EXPLAINABILITY: 'explainability',
  SECURITY: 'security',
...
export const FUTURE_GOVERNANCE_ARCHITECTURAL_RULES = Object.freeze({
  EXTEND_ARCH_012_FOUNDATIONS: 'extend-the-foundations-of-ARCH-012',
  PRESERVE_QUALIFIED_HUMAN_INTERPRETATION: 'preserve-qualified-human-interpretation',
  PRESERVE_ACCOUNTABLE_DECISION_AUTHORITY: 'preserve-accountable-decision-authority',
  INTRODUCE_AUTOMATION_GRADUALLY: 'introduce-automation-and-autonomy-gradually',
  MAINTAIN_OBLIGATION_EVIDENCE_TRACEABILITY: 'maintain-traceability-from-obligation-to-evidence-and-outcome',
  ALIGN_EXECUTABLE_POLICY_WITH_APPROVED_POLICY: 'keep-executable-policy-aligned-with-approved-policy',
  MAKE_DYNAMIC_APPLICABILITY_EXPLAINABLE: 'make-dynamic-applicability-explainable-and-versioned',
  VERIFY_AUTOMATED_CONTROLS_INDEPENDENTLY: 'verify-automated-controls-and-evidence-independently-where-required',
  PRESERVE_SECURITY_PRIVACY_ETHICS_AND_TENANT_ISOLATION: 'preserve-security-privacy-ethical-constraints-and-tenant-isolation',
  PREVENT_AI_EVIDENCE_FABRICATION: 'prevent-ai-fabrication-or-concealment-of-evidence',
  DEFINE_STOP_REVERSAL_ESCALATION_RECOURSE: 'define-stop-reversal-escalation-and-recourse',
  GOVERN_SELF_IMPROVEMENT_BY_HUMAN_APPROVAL: 'govern-self-improvement-through-human-approved-change',
  SUPPORT_FEDERATED_TENANT_PROPERTY_GOVERNANCE: 'support-federated-tenant-and-property-governance',
  AVOID_FRAMEWORK_AND_VENDOR_LOCK_IN: 'avoid-regulatory-framework-and-vendor-lock-in',
  INTEGRATE_WITH_ARCH_013_THROUGH_ARCH_020: 'integrate-with-ARCH-013-through-ARCH-020',
  USE_ADRS_FOR_MATERIAL_AUTHORITY_CHANGES: 'use-ADRs-for-material-changes-in-authority-or-governance-architecture',
  REMAIN_TECHNOLOGY_INDEPENDENT: 'remain-technology-independent-where-practical'
});

export const FUTURE_GOVERNANCE_CAPABILITY_ROADMAP_SEQUENCE = Object.freeze({
  STANDARDIZED_GOVERNANCE: 'Standardized Governance',
  INTEGRATED_TRACEABILITY: 'Integrated Traceability',
  MEASURED_GOVERNANCE: 'Measured Governance',
  CONTINUOUS_EVIDENCE_AND_ASSURANCE: 'Continuous Evidence and Assurance',
  PREDICTIVE_AND_ADAPTIVE_GOVERNANCE: 'Predictive and Adaptive Governance',
  BOUNDED_AUTONOMOUS_GOVERNANCE: 'Bounded Autonomous Governance',
  GOVERNED_SELF_IMPROVING_GOVERNANCE: 'Governed Self-Improving Governance'
});
