# ARCH-024-07 — Bundles, Packages & Eligibility

**Document ID:** ARCH-024-07
...
This chapter defines compositional offerings, required and optional components, compatibility, eligibility references, substitutions, and versioning.
...
* Compatibility and substitution rules
* Eligibility-policy references
* Bundle lifecycle and publication
...
* **acyclic composition:** enforced through policy, validation, evidence, and review.
* **version pinning:** enforced through policy, validation, evidence, and review.
* **deterministic validation:** enforced through policy, validation, evidence, and review.
* **price separation:** enforced through policy, validation, evidence, and review.
* **fulfillment feasibility checks:** enforced through policy, validation, evidence, and review.
