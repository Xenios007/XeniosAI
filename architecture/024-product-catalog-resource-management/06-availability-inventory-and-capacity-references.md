# ARCH-024-06 — Availability, Inventory & Capacity References

**Document ID:** ARCH-024-06
...
This chapter defines how catalog and resource services reference authoritative availability, inventory, schedule, capacity, and maintenance state.
...
* Availability-query contracts
* Inventory and capacity references
* Schedule and blackout references
* Maintenance and operability signals
* Freshness and confidence presentation
...
* **no oversell authority:** enforced through policy, validation, evidence, and review.
* **source timestamps:** enforced through policy, validation, evidence, and review.
* **cache bounds:** enforced through policy, validation, evidence, and review.
* **failure degradation:** enforced through policy, validation, evidence, and review.
* **allocation-domain confirmation:** enforced through policy, validation, evidence, and review.
