# ARCH-024-02 — Product & Service Model

**Document ID:** ARCH-024-02
...
This chapter defines product definitions, service definitions, variants, lifecycle, ownership, eligibility references, and commercial boundaries.
...
* Variant and option structure
* Lifecycle and publication status
* Provider and ownership references
* Terms, policies, and eligibility references
...
* **immutable published versions:** enforced through policy, validation, evidence, and review.
* **effective dating:** enforced through policy, validation, evidence, and review.
* **semantic identifiers:** enforced through policy, validation, evidence, and review.
* **draft review:** enforced through policy, validation, evidence, and review.
* **transactional separation:** enforced through policy, validation, evidence, and review.
