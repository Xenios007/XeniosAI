# ARCH-024-03 — Catalog, Classification & Discovery

**Document ID:** ARCH-024-03
...
This chapter defines catalog composition, taxonomy, categories, facets, search contracts, audience scope, and discovery projections.
...
* Catalog and catalog-entry lifecycle
* Taxonomy and classification
* Facets and discovery metadata
* Audience and channel visibility
* Search projection and result explanation
...
* **classification governance:** enforced through policy, validation, evidence, and review.
* **visibility policy:** enforced through policy, validation, evidence, and review.
* **index freshness:** enforced through policy, validation, evidence, and review.
* **localized metadata:** enforced through policy, validation, evidence, and review.
* **ranking provenance:** enforced through policy, validation, evidence, and review.
