# ARCH-024-09 — Operations, Governance & Assurance

**Document ID:** ARCH-024-09
...
This chapter defines ownership, service objectives, stewardship, publication controls, observability, incidents, assurance, and recovery.
...
* Publication and stewardship workflow
* Service and freshness objectives
...
* **separation of duties:** enforced through policy, validation, evidence, and review.
* **sensitive metadata controls:** enforced through policy, validation, evidence, and review.
* **tenant tests:** enforced through policy, validation, evidence, and review.
* **recovery exercises:** enforced through policy, validation, evidence, and review.
* **change approval:** enforced through policy, validation, evidence, and review.
