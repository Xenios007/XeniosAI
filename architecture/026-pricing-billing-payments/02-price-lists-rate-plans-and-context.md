# ARCH-026-02 — Price Lists, Rate Plans & Context

**Document ID:** ARCH-026-02
...
This chapter defines price books, rate plans, currencies, units, contexts, effective dates, and version selection.
