# ARCH-026-07 — Payment, Settlement, Refunds & Disputes

**Document ID:** ARCH-026-07
...
This chapter defines payment intents, authorization, capture, settlement, refund, chargeback, dispute, and financial state.
