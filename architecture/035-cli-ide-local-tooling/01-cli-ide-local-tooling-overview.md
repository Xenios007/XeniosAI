# ARCH-035-01 — CLI, IDE & Local Tooling Overview

**Document ID:** ARCH-035-01
...
This chapter positions local developer tools, personas, boundaries, trust model, portability, and quality attributes.
