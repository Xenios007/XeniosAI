# ARCH-035-08 — IDE Integration, Navigation, Validation & Feedback

**Document ID:** ARCH-035-08
...
This chapter defines editors, language services, registry navigation, inline validation, diagnostics, tasks, and secure actions.
