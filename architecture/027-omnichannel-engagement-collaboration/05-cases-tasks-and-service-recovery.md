# ARCH-027-05 — Cases, Tasks & Service Recovery

**Document ID:** ARCH-027-05
...
This chapter defines case lifecycle, tasks, SLA, ownership, complaint, dispute reference, remediation, and resolution.
