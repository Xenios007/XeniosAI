# ARCH-030-01 — Industry Solution Packs & Composable Applications Overview

**Document ID:** ARCH-030-01
...
This chapter positions solution packs, composable applications, ownership, conformance, and portfolio boundaries.
