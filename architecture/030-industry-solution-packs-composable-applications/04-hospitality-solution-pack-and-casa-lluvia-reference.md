# ARCH-030-04 — Hospitality Solution Pack & Casa Lluvia Reference

**Document ID:** ARCH-030-04

**Parent Document:** ARCH-030 — Industry Solution Packs & Composable Applications
...
This chapter defines hospitality bounded contexts, property operations, guest journeys, booking rules, add-ons, authorization, and validation.
