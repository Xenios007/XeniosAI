# ARCH-030-06 — Workflow, Agent, Knowledge & Integration Packaging

**Document ID:** ARCH-030-06
...
This chapter defines packaged automation, prompts, tools, knowledge, connectors, permissions, tests, and lifecycle.
