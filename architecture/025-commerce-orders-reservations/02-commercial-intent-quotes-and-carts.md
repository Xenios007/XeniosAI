# ARCH-025-02 — Commercial Intent, Quotes & Carts

**Document ID:** ARCH-025-02
...
This chapter defines inquiries, selections, quotations, carts, expiry, recalculation, customer confirmation, and conversion boundaries.
...
* Commercial intent record
* Quote lifecycle and validity
* Cart composition and ownership
* Recalculation and confirmation
* Conversion to commitment command
