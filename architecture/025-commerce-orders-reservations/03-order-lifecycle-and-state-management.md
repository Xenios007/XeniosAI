# ARCH-025-03 — Order Lifecycle & State Management

**Document ID:** ARCH-025-03
...
This chapter defines order aggregates, lines, state transitions, amendments, versioning, invariants, and domain events.
