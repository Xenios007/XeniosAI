# ARCH-025-05 — Availability, Allocation & Holds

**Document ID:** ARCH-025-05
...
This chapter defines authoritative checks, temporary holds, allocation, concurrency, expiry, release, and oversell prevention.
