# ARCH-025-06 — Modification, Cancellation & Compensation

**Document ID:** ARCH-025-06
...
This chapter defines change requests, policy evaluation, repricing references, cancellation, compensation, rollback, and customer confirmation.
