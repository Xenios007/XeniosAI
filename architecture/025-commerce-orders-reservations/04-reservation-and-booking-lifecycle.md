# ARCH-025-04 — Reservation & Booking Lifecycle

**Document ID:** ARCH-025-04
...
This chapter defines reservation requests, bookings, participants, time intervals, resources, status, confirmation, and industry extensions.
...
* Time and participant semantics
* Resource and service references
* Confirmation and status lifecycle
* Industry-specific booking extensions
