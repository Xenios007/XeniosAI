# ARCH-034-04 — Tool, Agent, Workflow & Capability Registration

**Document ID:** ARCH-034-04
...
This chapter defines callable capability metadata, inputs, outputs, authority, permissions, dependencies, limits, and evidence.
