# ARCH-031-05 — Credentials, Access Requests & Environment Entry

**Document ID:** ARCH-031-05

**Parent Document:** ARCH-031 — Developer Experience & Portal
...
This chapter defines credential issuance journeys, access packages, approvals, secrets display, rotation, revocation, and environment boundaries.
