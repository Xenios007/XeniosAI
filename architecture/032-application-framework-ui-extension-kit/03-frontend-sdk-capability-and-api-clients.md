# ARCH-032-03 — Frontend SDK, Capability & API Clients

**Document ID:** ARCH-032-03
...
This chapter defines typed clients, identity context, capability discovery, retries, streaming, errors, and contract versioning.
