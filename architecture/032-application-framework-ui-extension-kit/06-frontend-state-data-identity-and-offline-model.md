# ARCH-032-06 — Frontend State, Data, Identity & Offline Model

**Document ID:** ARCH-032-06
...
This chapter defines local state, server state, cache, identity and tenant context, optimistic behavior, offline use, and recovery.
