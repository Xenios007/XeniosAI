# ARCH-032-02 — Application Shell, Composition, Routing & Navigation

**Document ID:** ARCH-032-02
...
This chapter defines shells, routes, navigation, layouts, capability loading, error boundaries, and application composition.
