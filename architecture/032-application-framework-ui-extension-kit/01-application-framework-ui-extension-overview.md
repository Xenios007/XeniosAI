# ARCH-032-01 — Application Framework & UI Extension Overview

**Document ID:** ARCH-032-01
...
This chapter positions the framework, consumers, application types, extension boundaries, quality attributes, and portability.
