# ARCH-032-09 — Packaging, Testing, Versioning & Upgrade Paths

**Document ID:** ARCH-032-09
...
This chapter defines packages, compatibility, visual and accessibility tests, release channels, migrations, deprecation, and rollback.
